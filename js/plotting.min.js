...
for(s=this.stations[t],l=[],o=0,a=s.length;o<a;o++)r=s[o],r.displayed=[],l.push(function(){var o,a,s,l
for(s=r.dataloggers,l=[],o=0,a=s.length;o<a;o++)p=s[o],p.displayed=!1,p.color=null,e=this.plotter.indexOfValue(this.current[t],"dataLoggerId",p.id),e>-1?(i=this.current[t][e].color,p.displayed=!0,p.color=i,n={dataLoggerId:p.id,color:i},l.push(r.displayed.push(n))):l.push(void 0)
return l}.call(this))
...
s+=" </ul>"}return s+=" </ul> </li>",$(i).prepend(s),$("#"+l).dropdown(),o.bindSubMenuEvent(".subheader"),o.updateStationDropdown(t),o.appendStationMap(t,i,e.responseJSON.results,n)},this.api.get(r,a,s)},t.prototype.updateStationDropdown=function(t){var i,e,n,o,a,s,r,l,p,d,h,u,c,m
...
return t.stopPropagation(),e=$(this).attr("data-plot-id"),i.removeStation(e,$(this).attr("data-station-id")),$(this).append('<i class="icon-spinner icon-spin" data-plot-id="'+e+'"></i>')}):$('[data-station-id="'+e.id+'"][data-plot-id="'+t+'"]').off("click").on("click",function(t){var e
return t.stopPropagation(),e=$(this).attr("data-plot-id"),i.addStation(e,$(this).attr("data-station-id")),$(this).append('<i class="icon-spinner icon-spin" data-plot-id="'+e+'"></i>')})},d=this.stations[t],c=[],s=0,l=d.length;s<l;s++){for(u=d[s],o=this.__lcname(u.name),a="",u.displayed.length>0&&($('[data-region="'+o+'"][data-plot-id="'+t+'"]').css("background-color","rgb(248, 248, 248)").css("font-weight",700),a=n(u.displayed)),h=u.dataloggers,r=0,p=h.length;r<p;r++)m=h[r],$('[data-station-id="'+m.id+'"][data-plot-id="'+t+'"]> i.icon-circle').css("color",m.color),e(t,i.plotter,m)
c.push($('[data-region="'+o+'"][data-plot-id="'+t+'"] > span.region-dots').html(a))}return c},t.prototype.removeSpinner=function(t){return $('i.icon-spinner[data-plot-id="'+t+'"]').remove()},t.prototype.appendParameterDropdown=function(t,e,n,o){var a,s,r,l,p
...
return i=this,this.resetStationMap(t),this.setCurrent(t),s=function(t,e,n){return i.markers[t][e].setIcon({path:google.maps.SymbolPath.CIRCLE,scale:7,strokeWeight:2,fillOpacity:.8,fillColor:n}),i.markers[t][e].set("selected",!0),i.listeners[t][e].remove(),i.listeners[t][e]=i.markers[t][e].addListener("click",function(){var e
...
for(this.data=$.extend(!0,[],t),this.sourceCount=1,i=this.data.length-1,e=n=0,a=i;0<=a?n<=a:n>=a;e=0<=a?++n:--n)void 0===this.data[e]&&console.log(o+" on construct, @data[i] is (i, row)",e,this.data[e])
this.test=function(t,i,e){var n,a,s,r,l,p
for(o=this.preError+"test(...):",a=e.length,n=0,l=!1,s=0,r=e.length;s<r;s++){if(p=e[s],void 0===t[p])throw new Error(o+" key '"+p+"' not found in primary data set.")
if(void 0===i[p])throw new Error(o+" key '"+p+"' not found in joining data set.")
t[p]instanceof Date?t[p].getTime()===i[p].getTime()&&n++:t[p]===i[p]&&n++}return n===a&&(l=!0),l}}return t.prototype.join=function(t,e){var n,o,a,s,r,l,p,d,h,u,c,m,f,y,g
...
if(r=o.template[i],void 0===r.__data&&(r.__data=[]),void 0===r.__data[t]?r.__data[t]=new window.Plotting.Data(e.responseJSON.results):(s.data_logger===r.options.y2.dataLoggerId?e.responseJSON.results=r.__data.appendKeys(e.responseJSON.results,"_2"):s.data_logger===r.options.y3.dataLoggerId&&(e.responseJSON.results=r.__data.appendKeys(e.responseJSON.results,"_3")),r.__data[t].join(e.responseJSON.results,[r.proto.options.x.variable])),r.__data[t].getSourceCount()===a&&(r.proto.initialized?(r.proto.appendData(r.__data[t].get()),r.proto.update()):(r.proto.setData(r.__data[t].get()),r.proto.append()),delete r.__data[t]),o.controls.removeSpinner(i),o.controls.updateStationDropdown(i),o.controls.updateStationMap(i),"min"===n?r.proto.state.requested.min=!1:"max"===n&&(r.proto.state.requested.max=!1),o.updates--,o.updates<0)return o.updates=0},this.api.get(p,s,r)},t.prototype.prependData=function(t){var i,e,n,o,a,s,r,l
...
return s},t.prototype.addStation=function(t,i){var e,n,o,a,s,r,l,p,d,h
...
d=this.template[t].proto.getState(),a=this.template[t].proto.options.y.variable,n=d.range.data.max.getTime(),o=$.extend(!0,{},this.template[t].proto.options.dataParams[0]),o.data_logger=i,e=this.template[t].proto.options.dataParams.push(o),this.setNewOptions(t,a,i),h=this.uuid(),l=this.template[t].proto.options.dataParams,p=[]
for(r in l)s=l[r],this.template[t].proto.options.dataParams[r].max_datetime=this.format(new Date(n)),this.template[t].proto.options.dataParams[r].limit=d.length.data,p.push(this.getAppendData(h,t,r))
return p},t.prototype.removeStation=function(t,i){var e,n,o,a
