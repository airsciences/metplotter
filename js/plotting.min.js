...
return i={battery_voltage:{min:8,max:16,maxBar:null},temperature:{min:null,max:null,maxBar:32},equip_temperature:{min:null,max:null,maxBar:null},relative_humidity:{min:0,max:102,maxBar:null},net_solar:{min:0,max:800,maxBar:null},snow_depth:{min:0,max:200,maxBar:null},snowfall_24_hour:{min:0,max:30,maxBar:null},intermittent_snow:{min:null,max:null,maxBar:null},wind_direction:{min:0,max:360,maxBar:null},precipitation:{min:0,max:.4,maxBar:null},wind_speed_average:{min:0,max:null,maxBar:null},solar_pyranometer:{min:0,max:null,maxBar:null},barometric_pressure:{min:null,max:null,maxBar:null}},i[t]},t.prototype.getVariableInfo=function(t){var i
