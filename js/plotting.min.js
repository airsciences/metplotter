...
return this.appendCrosshairTarget(n),n}},t.prototype.setCrosshair=function(t,i){var e,n,s,o,r,a,l,p,h,d,u,c,f,m,g,y,x,v
if(this.initialized){m=this.preError+".setCrosshair(mouse)",e=this,o=this.definition.dimensions,p=function(t){switch(!1){case!(t>360||t<0):return"INV"
case!(t>=0&&t<11.25):return"N"
case!(t>=11.25&&t<33.75):return"NNE"
case!(t>=33.75&&t<56.25):return"NE"
...
return void 0!==this.options.y[1]&&(v=[],this.svg.selectAll(".focus-text").attr("transform",function(t,i){return y={ind:i,y:parseInt(d3.select(this).attr("y")),offset:0},v.push(y),""}).call(function(t){return v.sort(function(t,i){return t.y-i.y}),v.forEach(function(t,i){var e,n
if(i>0)return n=0,v[i].y<v[i-1].y+v[i-1].offset&&(n=v[i-1].y+v[i-1].offset-v[i].y),e=Math.max(0,v[i-1].y+v[i-1].offset+18-(v[i].y+n)),v[i].offset=e+n})}).attr("transform",function(t,i){var n
return n=e.plotter.lib.indexOfValue(v,"ind",i),"translate (0, "+v[n].offset+")"})),i}},t.prototype.showCrosshair=function(){var t,i,e,n
if(this.initialized){this.crosshairs.select(".crosshair-x").style("display",null),this.crosshairs.select(".crosshair-x-under").style("display",null),this.focusDateText.style("display",null),t=this.options.y,i=[]
