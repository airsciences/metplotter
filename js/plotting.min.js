...
if(i=this.processDataSet(t,e),o=new window.Plotter.Data(this.data[e]),o.append(i,["x"]),this.data[e]=o._clean(o.get()),this.data[e]=this.data[e].sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.removeData=function(t){if(t>=0&&(console.log("Remove Data (data)",t,this.data),delete this.data[t],delete this.options[t],console.log("Remove Data Complete (data)",t,this.data),this.svg.select(".line-plot-area-"+t).remove(),this.svg.select(".line-plot-path-"+t).remove(),this.svg.select(".focus-circle-"+t).remove(),this.svg.select(".focus-text-"+t).remove(),this.initialized))return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.setDataState=function(){var t,e,i,o,n,r,s,a
...
this.overlay.remove(),this.overlay=this.svg.append("rect").attr("class","plot-event-target"),this.appendCrosshairTarget(),this.appendZoomTarget(),this.calculateYAxisDims(this.data),this.definition.y.domain([this.definition.y.min,this.definition.y.max]).nice(),n=this.data
