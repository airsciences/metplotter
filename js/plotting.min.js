...
this.preError="Plotting.Dropdown",this.plotter=t,o={target:null},this.options=Object.mergeDefaults(e,o),n={token:null,expires:null,expired:!0},i=Object.mergeDefaults(i,n),this.maps=[],this.markers={},this.listeners={},this.api=new window.Plotting.API(i.token)}return t.prototype.appendStationDropdown=function(t,i,e,n){var o,a,s,r,l
return r=location.protocol+"//dev.nwac.us/api/v5/dataloggerregion?sensor_name="+e,o=this,a={},l=this.uuid(),s=function(e){var a,s,r,p,d,h,u,c,f,m,y,g,v,x,b,w,P,D,S,T,k,_,M,C,O,N,I,A
for(f='<div class="dropdown"> <li><a id="'+l+'" class="station-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="station-dropdown-'+t+'" class="dropdown-menu pull-right">',_=e.responseJSON.results,m=0,b=_.length;b>m;m++){for(I=_[m],u="",k="",a='<span class="station-dots">',p=0,M=I.dataloggers,g=0,w=M.length;w>g;g++)h=M[g],d=o.isCurrent(n,"dataLoggerId",h.id),d&&(p++,a=a+' <i class="icon-circle" style="color: '+d.color+'"></i>')
for(p>0&&(k='style="background-color: rgb(248,248,248)"',u='style="font-weight: 700"'),f=f+' <li class="subheader" '+k+"> <a "+u+' href="#"><i class="icon-caret-down" style="margin-right: 6px"></i> '+I.name+" "+a+'</span></a> </li> <ul class="list-group-item sublist" style="display: none;">',C=I.dataloggers,v=0,P=C.length;P>v;v++)A=C[v],d=o.isCurrent(n,"dataLoggerId",A.id),c="",d&&(c='style="color: '+d.color+'"'),y="data-logger-"+A.id+"-plot-"+t,r='<i id="'+y+'" class="icon-circle" '+c+"></i>",s="add-station-"+t+"-"+A.id,f=f+' <li class="station" id="'+s+'" data-station-id="'+A.id+'" data-plot-id="'+t+'" style="padding: 1px 5px; cursor: pointer; list-style-type: none" onclick=""> '+r+" "+A.datalogger_name+" | "+A.elevation+" ft</li>"
f+=" </ul>"}for(f+=" </ul> </li>",$(i).prepend(f),O=e.responseJSON.results,x=0,D=O.length;D>x;x++)for(I=O[x],N=I.dataloggers,T=0,S=N.length;S>T;T++)A=N[T],s="add-station-"+t+"-"+A.id,$("#"+s).on("click",function(t){var i,e
...
for(l='<div class="dropdown"> <li><a id="'+p+'" class="parameter-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="param-dropdown-'+t+'" class="dropdown-menu pull-right" role="menu" aria-labelledby="'+p+'">',f=n.responseJSON.results,d=0,u=f.length;u>d;d++)c=f[d],"wind_speed_minimum"===c.field_name||"wind_speed_maximum"===c.field_name||("wind_speed_average"===c.field_name?(a=c.field_name,s=a.replace("_","-"),h=s+"-plot-"+t,m=o.variable,i.call(c.field_name,m)>=0&&(r='<i id="'+h+'" class="parameter-'+c.parameter+' icon-circle" style="color: '+o.color+'"></i>')):(a=c.field_name,s=a.replace("_","-"),h=s+"-plot-"+t,r=o.variable===c.field_name?'<i id="'+h+'" class="icon-circle" style="color: '+o.color+'"></i>':'<i id="'+h+'" class="icon-circle" style=""></i>')),l=l+' <li><a style="cursor: pointer" onclick="plotter.addVariable('+t+", '"+a+"')\">"+r+" "+c.sensortype_name+"</a></li>"
return l+=" </ul> </li> </div>",$(e).prepend(l),$("#"+p).dropdown()},this.api.get(l,s,r)},t.prototype.updateParameterDropdown=function(t){var i,e,n
return e=this.plotter.template[t].proto.options,null!==e.y.variable&&(i=e.y.variable.replace("_","-"),n=i+"-plot-"+t,$(e.target).find("#"+n).css("color",e.y.color)),null!==e.y2.variable&&(i=e.y2.variable.replace("_","-"),n=i+"-plot-"+t,$(e.target).find("#"+n).css("color",e.y2.color)),null!==e.y3.variable?(i=e.y3.variable.replace("_","-"),n=i+"-plot-"+t,$(e.target).find("#"+n).css("color",e.y3.color)):void 0},t.prototype.appendStationMap=function(t,i,e,n){var o,a,s,r,l,p,d,h,u,c,f,m,y,g,v,x,b,w,P,D,S,T,k,_
for(o=this,_=this.uuid(),u="map-control-"+t,c='<li data-toggle="popover" data-placement="left"> <i id="map-'+t+'" class="icon-map-marker" style="cursor: pointer"></i> </li> <div class="popover" style="max-width: 356px;"> <div class="arrow"></div> <div class="popover-content"> <div id="'+u+'" style="width: 312px; height: 312px;"></div> </div> </div>',$(i).prepend(c),$("#map-"+t).on("click",function(){return o.plotter.controls.toggleMap(t)}),this.maps[t]=new google.maps.Map(document.getElementById(u),{center:new google.maps.LatLng(46.98,-121.98),zoom:6,maxZoom:12,mapTypeId:"terrain",zoomControl:!0,mapTypeControl:!1,scaleControl:!1,streetViewControl:!1,rotateControl:!1,fullscreenControl:!1}),m=new google.maps.InfoWindow({content:"",disableAutoPan:!0}),s=new google.maps.LatLngBounds,a=[],f=0,v=e.length;v>f;f++)for(S=e[f],D=S.dataloggers,y=0,x=D.length;x>y;y++)k=D[y],h="rgb(200,200,200)",T=5,P=.5,d="map-plot-"+t+"-station-"+k.id,p=o.isCurrent(n,"dataLoggerId",k.id),p&&(h=p.color,T=7,P=.8,a.push(new google.maps.LatLng(k.lat,k.lon))),w=new google.maps.Marker({position:{lat:k.lat,lng:k.lon},id:d,tooltip:k.datalogger_name+" - "+k.elevation+" ft",dataloggerid:k.id,icon:{path:google.maps.SymbolPath.CIRCLE,scale:T,strokeWeight:2,fillOpacity:P,fillColor:h},selected:!1}),w.addListener("mouseover",function(){return m.setContent(this.tooltip),m.open(o.maps[t],this)}),w.addListener("mouseout",function(){return m.close()}),this.listeners[d]=w.addListener("click",function(){return console.log("Marker clicked",this),o.plotter.addStation(t,this.dataloggerid)}),r=this.markers[d]=w,this.markers[d].setMap(this.maps[t])
...
i=this,o=this.markers,a=[]
for(e in o)n=o[e],n.setIcon({path:google.maps.SymbolPath.CIRCLE,scale:5,strokeWeight:2,fillOpacity:.5,fillColor:"rgb(200,200,200)"}),n.set("selected",!1),i.listeners[e].remove(),a.push(i.listeners[e]=n.addListener("click",function(){var e
return e=this.get("dataloggerid"),i.plotter.addStation(t,e)}))
return a},t.prototype.updateStationMap=function(t){var i,e,n,o,a,s
return i=this,this.resetStationMap(t),s=function(t,e,n){return i.markers[e].setIcon({path:google.maps.SymbolPath.CIRCLE,scale:7,strokeWeight:2,fillOpacity:.8,fillColor:n}),i.markers[e].set("selected",!0),i.listeners[e].remove(),i.listeners[e]=i.markers[e].addListener("click",function(){var e
...
return i=this.processData(t),e=new Plotting.Data(this.data),e.append(i,["x"]),this.data=e._clean(e.get()),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized?(this.setDataState(),this.setIntervalState(),this.setDataRequirement()):void 0},t.prototype.removeData=function(t){var i,e,n,o,a
a=[],o=this.data
for(e in o)n=o[e],delete n[t],a[e]=n
return i=new Plotting.Data(a),this.data=i.get(),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized?(this.setDataState(),this.setIntervalState(),this.setDataRequirement()):void 0},t.prototype.setDataState=function(){var t,i,e,n
...
return o=this.preError+".getTemplate(...)",a=this.options.href+"/api/v5/plothandler/"+this.options.plotHandlerId,e=null,i=this,n=function(t){var e,n,a
if(null===t.responseJSON||t.responseJSON.error)return void console.log(o+".callback(...) error detected (data)",t)
try{e=JSON.parse(t.responseJSON.template_data),i.template=e.templateData}catch(a){n=a,console.log(o+".callback(...) JSON.parse error",n)}return i.parseDates(i.template)},this.syncronousapi.get(a,e,n)},t.prototype.parseDates=function(t){var i,e,n,o,a,s,r,l,p,d
for(i=this,s=function(t){var i,e
return t.includes("now")&&(e=new Date,t.includes("(")&&(i=parseInt(t.replace("(","").replace(")","").replace("now","")),e=new Date(e.getTime()+36e5*i)),t=this.format(e)),t},l=[],e=0,o=t.length;o>e;e++){for(p=t[e],r=p.dataParams,n=0,a=r.length;a>n;n++)d=r[n],d.max_datetime=s(d.max_datetime)
...
if(this.isAdmin()!==!1)return n=this.preError+".putTemplate()",o=this.options.href+"/api/v5/plothandler/",i={id:this.options.templateId,template_data:{templateData:this.template}},t=this,e=function(t){return null===t.responseJSON||t.responseJSON.error?void console.log(n+".callback(...) error detected (data)",t):console.log(n+".callback() success saving template.")},this.api.put(o,i,e)},t.prototype.getStationParamData=function(t,i){var e,n,o,a,s
...
return e=this.template[t],e.options.dataParams=e.dataParams,i=e.options.dataParams.length,i>0&&(e.options.y.dataLoggerId=e.options.dataParams[0].data_logger),i>1&&(e.options.y2.dataLoggerId=e.options.dataParams[1].data_logger),i>2?e.options.y2.dataLoggerId=e.options.dataParams[2].data_logger:void 0},t.prototype.getAppendData=function(t,i,e){var n,o,a,s,r,l
return r=this.preError+".getAppendData(key, dataParams)",l=this.options.href+"/api/v5/measurement",n=this,a=this.template[i].proto.options.dataParams[e],o=this.template[i].proto.options.dataParams.length,s=function(e){var a
...
return e=null,a=this.template[t],o=this.template[t].proto,n=this.indexOfValue(a.dataParams,"data_logger",i),o.options.y.dataLoggerId===i?e="y":o.options.y2.dataLoggerId===i?e="y2":o.options.y3.dataLoggerId===i&&(e="y3"),n>-1&&(a.dataParams.splice(n,1),o.options[e]=null,o.appendData(),"y"===e&&(o.options.y=Object.mergeDefaults(o.options.y,o.defaults.y)),"y2"===e&&(o.options.y2=Object.mergeDefaults(o.options.y2,o.defaults.y2)),"y3"===e&&(o.options.y3=Object.mergeDefaults(o.options.y3,o.defaults.y3)),o.getDefinition(),o.removeData(e),o.update()),this.controls.updateStationDropdown(t),this.controls.updateStationMap(t)},t.prototype.zoom=function(t){var i,e,n,o,a
