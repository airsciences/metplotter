...
case!(t>=326.25&&t<348.75):return"NNW"
case!(t>=348.75&&t<=360):return"N"}},m=this.data
for(c in m)g=m[c],r=this.overlay.node(),s=g,i=i?i:d3.mouse(r),y=this.definition.x.invert(i[0]+o.leftPadding),t&&(y=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(s,y,1),y.getTime()<this.state.range.data[c].min.getTime()&&u--,y.getTime()>this.state.range.data[c].max.getTime()&&u--,u=y.getMinutes()>=30?u:u-1,null!=s[u]&&(d=t?t.applyX(this.definition.x(s[u].x)):this.definition.x(s[u].x),h=[],a=[],null!==this.options.y[c].variable&&(a[c]=s[u],null!=a[c]&&(h[c]=this.definition.y(a[c].y),n=this.displayDate(a[c].x),isNaN(h[c])||null==a[c].y||this.focusCircle[c].attr("transform","translate(0, 0)"))),l=d-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),this.focusDateText.attr("x",l-90).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n)),null===this.options.y[c].variable||isNaN(h[c])||null==a[c].y||(this.focusCircle[c].attr("cx",d).attr("cy",h[c]),this.focusText[c].attr("x",d+o.leftPadding/10).attr("y",h[c]-o.topPadding/10).text(a[c].y?"wind_direction"===e.options.y[0].variable?p(a[c].y):a[c].y.toFixed(1)+" "+this.options.y[c].units:void 0)))
return i}},t.prototype.showCrosshair=function(){var t,i,e,n
if(this.initialized){this.crosshairs.select(".crosshair-x").style("display",null),this.crosshairs.select(".crosshair-x-under").style("display",null),this.focusDateText.style("display",null),t=this.options.y,i=[]
