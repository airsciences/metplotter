...
for(e in n)o=n[e],t=this.state.interval.data[e].max<this.options.requestInterval.data,this.state.request.data[e]={min:this.state.interval.data[e].min<this.options.requestInterval.data,max:t},null==this.state.requested.data[e]?s.push(this.state.requested.data[e]={min:!1,max:!1}):s.push(void 0)
...
return this.appendCrosshairTarget(n),n}},t.prototype.setCrosshair=function(t,i){var e,n,s,o,r,a,l,p,d,h,u,c,f,m,g,y
if(this.initialized){f=this.preError+".setCrosshair(mouse)",e=this,o=this.definition.dimensions,p=function(t){switch(!1){case!(t>360||t<0):return"INV"
...
case!(t>=348.75&&t<=360):return"N"}},m=this.data
for(c in m)g=m[c],r=this.overlay.node(),s=g,i=i?i:d3.mouse(r),y=this.definition.x.invert(i[0]+o.leftPadding),t&&(y=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(s,y,1),y.getTime()<this.state.range.data[c].min.getTime()&&u--,y.getTime()>this.state.range.data[c].max.getTime()&&u--,u=y.getMinutes()>=30?u:u-1,null!=s[u]&&(d=t?t.applyX(this.definition.x(s[u].x)):this.definition.x(s[u].x),h=[],a=[],null!==this.options.y[c].variable&&(a[c]=s[u],null!=a[c]&&(h[c]=this.definition.y(a[c].y),n=this.displayDate(a[c].x),isNaN(h[c])||null==a[c].y||this.focusRect[c].attr("transform","translate(0, 0)"))),l=d-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),this.focusDateText.attr("x",l-120).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n)),null===this.options.y[c].variable||isNaN(h[c])||null==a[c].y||(this.focusRect[c].attr("width",t.k*this.definition.x1.bandwidth()).attr("x",d).attr("y",h[c]),this.focusText[c].attr("x",d+o.leftPadding/10+t.k*this.definition.x1.bandwidth()+2).attr("y",h[c]-o.topPadding/10).text(null!=a[c].y?"wind_direction"===e.options.y[0].variable?p(a[c].y):a[c].y.toFixed(2)+" "+this.options.y[c].units:void 0)))
...
return a},t.prototype.add=function(t){var i,e,n,s,o,r,a,l,p,d
...
return r=this.preError+".get()",a=this.endpoint(),s=this,o=function(n){var o,a,l,p,d
if(null==n.responseJSON)throw new Error(r+" error requesting data.")
if(0===n.responseJSON.results.length)throw new Error(r+" no set found.")
for(d=s.plotter.plots,a=0,l=d.length;a<l;a++)if(p=d[a],void 0!==p){o=p.proto.transform
...
case!(t>=326.25&&t<348.75):return"NNW"
case!(t>=348.75&&t<=360):return"N"}},m=this.data
for(c in m)g=m[c],r=this.overlay.node(),s=g,i=i?i:d3.mouse(r),y=this.definition.x.invert(i[0]+o.leftPadding),t&&(y=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(s,y,1),y.getTime()<this.state.range.data[c].min.getTime()&&u--,y.getTime()>this.state.range.data[c].max.getTime()&&u--,u=y.getMinutes()>=30?u:u-1,null!=s[u]&&(d=t?t.applyX(this.definition.x(s[u].x)):this.definition.x(s[u].x),h=[],a=[],null!==this.options.y[c].variable&&(a[c]=s[u],null!=a[c]&&(h[c]=this.definition.y(a[c].y),n=this.displayDate(a[c].x),isNaN(h[c])||null==a[c].y||this.focusCircle[c].attr("transform","translate(0, 0)"))),l=d-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),this.focusDateText.attr("x",l-120).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n)),null===this.options.y[c].variable||isNaN(h[c])||null==a[c].y||(this.focusCircle[c].attr("cx",d).attr("cy",h[c]),this.focusText[c].attr("x",d+o.leftPadding/10).attr("y",h[c]-o.topPadding/10).text(a[c].y?"wind_direction"===e.options.y[0].variable?p(a[c].y):a[c].y.toFixed(1)+" "+this.options.y[c].units:void 0)))
return i}},t.prototype.showCrosshair=function(){var t,i,e,n
if(this.initialized){this.crosshairs.select(".crosshair-x").style("display",null),this.crosshairs.select(".crosshair-x-under").style("display",null),this.focusDateText.style("display",null),t=this.options.y,i=[]
...
window.Plotter||(window.Plotter={}),window.Plotter.LiveSync=t=function(){function t(t){this.preError="Plotter.LiveSync",this.plotter=t,this.api=this.plotter.i.api,this.requests={},this.endpoint=function(){return this.plotter.options.href+"/api/v5/measurement"}}return t.prototype.append=function(t,i,e){var n,s,o,r,a,l,p,d,h
return n=new Date,o=n.getTimezoneOffset()/60,s=new Date(n.getTime()-36e5*(8-o)),console.log(s,e.range.data[i].max,e.range.data[i].max>=s),e.range.data[i].max>=s||(l=this.plotter.options.updateLength,a=e.range.data[i].max.getTime(),d=new Date(a+36e5*this.plotter.options.updateLength),d>s&&(l=Math.round((d.getTime()-s.getTime())/36e5)),p=this.plotter.lib.format(new Date(d)),l<this.plotter.options.minUpdateLength||(r=this.plotter.i.template.forSync(t,i,p,l),h=this.plotter.lib.uuid(),this.requests[h]={ready:!1,requested:!1},this.requests[h].requested=this.get(t,i,h,r,"max")))},t.prototype.prepend=function(t,i,e){var n,s,o,r
...
this.refreshCounter++,s=this.plots
for(n in s)if(e=s[n],null!=e&&e.proto.initialized){a=e.proto.getState(),o=a.request.data
for(i in o)r=o[i],r.min===!0&&this.isReady()&&e.proto.state.requested.data[i].min===!1&&(this.updates++,e.proto.state.requested.data[i].min=!0,this.i.livesync.prepend(n,i,a)),this.refreshCounter%this.waitCounter===0&&r.max===!0&&this.isReady()&&e.proto.state.requested.data[i].max===!1&&(this.updates++,e.proto.state.requested.data[i].max=!0,this.i.livesync.append(n,i,a))}if(!t)return setTimeout(Plotter.Handler.prototype.listen.bind(this),this.options.refresh)},t.prototype.append=function(){var t,i,e,n,s
t=this,n=this.plots
