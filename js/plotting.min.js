...
this.preError="Plotting.API",e=this.preError+".constructor()",this.async=!0,"undefined"!=typeof i&&(this.async=i),this.getAccessToken=function(){return t},this.getAccessTokenValue=function(){return"Token "+t}}return t.prototype.build=function(){var t,i,e,n,o
if(n=this.preError+".build()",o=null,XMLHttpRequest)o=new XMLHttpRequest
else try{o=new ActiveXObject("Msxml2.XMLHTTP")}catch(i){t=i
try{o=new ActiveXObject("Microsoft.XMLHTTP")}catch(e){t=e,console.error(n,"Cannot specify XMLHTTPRequest (error)",t)}}return o},t.prototype.get=function(t,i,e){var n,o,a,s
a=this.preError+".get(uri, params, callback)",s=this.build(),"undefined"!=typeof e&&(s.onreadystatechange=function(){var t,i,n
if(4===s.readyState){if(200!==s.status&&304!==s.status)return console.log(a+" HTTP error, (status): "+s.status),void(s=null)
n={response:s.response,responseText:s.responseText,responseJSON:null}
try{n.responseJSON=JSON.parse(n.responseText)}catch(i){t=i,n.responseJSON=null}return e(n)}}),i=this.encodeArgs("GET",i)
try{s.open("GET",t+i,this.async),s.setRequestHeader("Authorization",this.getAccessTokenValue()),s.send(null)}catch(o){n=o,console.log(a+"catch(error).",n)}},t.prototype.put=function(){var t,i,e,n,o
n=this.preError+".put(uri, params, callback)",o=this.build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i,e
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(n+" HTTP error, (status): "+o.status),void(o=null)
e={response:o.response,responseText:o.responseText,responseJSON:null}
try{e.responseJSON=JSON.parse(e.responseText)}catch(i){t=i,e.responseJSON=null}return callback(e)}}),t=this.encodeArgs("PUT",t)
try{o.open("PUT",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(e){i=e,console.log(n+"catch(error).",i)}},t.prototype.post=function(){var t,i,e,n,o
n=this.preError+".post(uri, params, callback)",o=build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i,e
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(n+" HTTP error, (status): "+o.status),void(o=null)
e={response:o.response,responseText:o.responseText,responseJSON:null}
try{e.responseJSON=JSON.parse(e.responseText)}catch(i){t=i,e.responseJSON=null}return callback(e)}}),t=this.encodeArgs("POST",t)
try{o.open("POST",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(e){i=e,console.log(n+"catch(error).",i)}},t.prototype["delete"]=function(){var t,i,e,n,o
n=this.preError+".delete(uri, params, callback)",o=this.build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i,e
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(n+" HTTP error, (status): "+o.status),void(o=null)
e={response:o.response,responseText:o.responseText,responseJSON:null}
...
try{o.open("DELETE",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(e){i=e,console.log(n+"catch(error).",i)}},t.prototype.encodeArgs=function(t,i){var e,n,o,a,s,r
if(r=this.preError+"encodeArgs(type, json_args)",n="",e=0,"string"==typeof i)try{i=JSON.parse(i)}catch(s){a=s,console.log(r+"catch(error).",a)}if("POST"===t||"PUT"===t)n=JSON.stringify(i)
else if("GET"===t)for(o in i)n=0===e?"?"+o+"="+i[o]:n+"&"+o+"="+i[o],e++
return n},t}()}).call(this),function(){var t,i=[].indexOf||function(t){for(var i=0,e=this.length;e>i;i++)if(i in this&&this[i]===t)return i
return-1}
window.Plotting||(window.Plotting={}),window.Plotting.Controls=t=function(){function t(t,i,e){var n,o
this.preError="Plotting.Dropdown",this.plotter=t,o={target:null},this.options=Object.mergeDefaults(e,o),n={token:null,expires:null,expired:!0},i=Object.mergeDefaults(i,n),this.maps=[],this.markers=[],this.api=new window.Plotting.API(i.token)}return t.prototype.appendStationDropdown=function(t,i,e,n){var o,a,s,r,l
return r=location.protocol+"//dev.nwac.us/api/v5/dataloggerregion?sensor_name="+e,o=this,a={},l=this.uuid(),s=function(e){var a,s,r,p,d,h,u,c,f,m,y,g,v,x,b,w,P,D,T,S,_,k,M,C,N,O,I,A
for(f='<div class="dropdown"> <li><a id="'+l+'" class="station-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="station-dropdown-'+t+'" class="dropdown-menu dropdown-menu-right">',k=e.responseJSON.results,m=0,b=k.length;b>m;m++){for(I=k[m],u="",_="",a='<span class="station-dots">',p=0,M=I.dataloggers,g=0,w=M.length;w>g;g++)h=M[g],d=o.isCurrent(n,"dataLoggerId",h.id),d&&(p++,a=a+' <i class="icon-circle" style="color: '+d.color+'"></i>')
for(p>0&&(_='style="background-color: rgb(248,248,248)"',u='style="font-weight: 700"'),f=f+' <li class="subheader" '+_+"> <a "+u+' href="#"><i class="icon-caret-down" style="margin-right: 6px"></i> '+I.name+" "+a+'</span></a> </li> <ul class="list-group-item sublist" style="display: none;">',C=I.dataloggers,v=0,P=C.length;P>v;v++)A=C[v],d=o.isCurrent(n,"dataLoggerId",A.id),c="",d&&(c='style="color: '+d.color+'"'),y="data-logger-"+A.id+"-plot-"+t,r='<i id="'+y+'" class="icon-circle" '+c+"></i>",s="add-station-"+t+"-"+A.id,f=f+' <li class="station" id="'+s+'" data-station-id="'+A.id+'" data-plot-id="'+t+'" style="padding: 1px 5px; cursor: pointer; list-style-type: none" onclick=""> '+r+" "+A.datalogger_name+" | "+A.elevation+" ft</li>"
f+=" </ul>"}for(f+=" </ul> </li>",$(i).prepend(f),N=e.responseJSON.results,x=0,D=N.length;D>x;x++)for(I=N[x],O=I.dataloggers,S=0,T=O.length;T>S;S++)A=O[S],s="add-station-"+t+"-"+A.id,$("#"+s).on("click",function(t){var i,e
return t.stopPropagation(),i=$(this).attr("data-plot-id"),e=$(this).attr("data-station-id"),o.plotter.addStation(i,e)})
return $("#"+l).dropdown(),o.bindSubMenuEvent(".subheader"),o.appendStationMap(t,i,e.responseJSON.results,n)},this.api.get(r,a,s)},t.prototype.updateStationDropdown=function(t){var i,e,n,o,a
return i=this,o=this.plotter.template[t].proto.options,e="",null!==o.y.dataLoggerId&&(n=o.y.dataLoggerId,e=' <i class="icon-circle" style="color: '+o.y.color+'"></i>',a="data-logger-"+n+"-plot-"+t,$(o.target).find("#"+a).css("color",o.y.color).parent().parent().prev().css("background-color","rgb(248,248,248)").children(":first").children(".station-dots").empty().append(e),$("#add-station-"+t+"-"+n).on("click",function(t){var e,n
return t.stopPropagation(),console.log("this",$(this)),e=$(this).attr("data-plot-id"),n=$(this).attr("data-station-id"),i.plotter.removeStation(e,n)})),null!==o.y2.variable&&(n=o.y2.dataLoggerId,e=' <i class="icon-circle" style="color: '+o.y2.color+'"></i>',a="data-logger-"+n+"-plot-"+t,$(o.target).find("#"+a).css("color",o.y2.color).parent().parent().prev().css("background-color","rgb(248,248,248)").children(":first").append(e),$("#add-station-"+t+"-"+n).on("click",function(t){var e,n
return t.stopPropagation(),e=$(this).attr("data-plot-id"),n=$(this).attr("data-station-id"),i.plotter.removeStation(e,n)})),null!==o.y3.variable?(n=o.y3.dataLoggerId,e=' <i class="icon-circle" style="color: '+o.y3.color+'"></i>',a="data-logger-"+n+"-plot-"+t,$(o.target).find("#"+a).css("color",o.y3.color).parent().parent().prev().css("background-color","rgb(248,248,248)").children(":first").append(e),$("#add-station-"+t+"-"+n).on("click",function(t){var e,n
return t.stopPropagation(),e=$(this).attr("data-plot-id"),n=$(this).attr("data-station-id"),i.plotter.removeStation(e,n)})):void 0},t.prototype.appendParameterDropdown=function(t,e,n,o){var a,s,r,l,p
return l=location.protocol+"//dev.nwac.us/api/v5/sensortype?sensors__data_logger="+n,s={},p=this.uuid(),a=[],r=function(n){var a,s,r,l,d,h,u,c,f,m
for(l='<div class="dropdown"> <li><a id="'+p+'" class="parameter-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="param-dropdown-'+t+'" class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="'+p+'">',f=n.responseJSON.results,d=0,u=f.length;u>d;d++)c=f[d],"wind_speed_minimum"===c.field_name||"wind_speed_maximum"===c.field_name||("wind_speed_average"===c.field_name?(a=c.field_name,s=a.replace("_","-"),h=s+"-plot-"+t,m=o.variable,i.call(c.field_name,m)>=0&&(r='<i id="'+h+'" class="parameter-'+c.parameter+' icon-circle" style="color: '+o.color+'"></i>')):(a=c.field_name,s=a.replace("_","-"),h=s+"-plot-"+t,r=o.variable===c.field_name?'<i id="'+h+'" class="icon-circle" style="color: '+o.color+'"></i>':'<i id="'+h+'" class="icon-circle" style=""></i>')),l=l+' <li><a style="cursor: pointer" onclick="plotter.addVariable('+t+", '"+a+"')\">"+r+" "+c.sensortype_name+"</a></li>"
return l+=" </ul> </li> </div>",$(e).prepend(l),$("#"+p).dropdown()},this.api.get(l,s,r)},t.prototype.updateParameterDropdown=function(t){var i,e,n
return e=this.plotter.template[t].proto.options,null!==e.y.variable&&(i=e.y.variable.replace("_","-"),n=i+"-plot-"+t,console.log("Update-Dropdown y",n),$(e.target).find("#"+n).css("color",e.y.color)),null!==e.y2.variable&&(i=e.y2.variable.replace("_","-"),n=i+"-plot-"+t,console.log("Update-Dropdown y2",n),$(e.target).find("#"+n).css("color",e.y2.color)),null!==e.y3.variable?(i=e.y3.variable.replace("_","-"),n=i+"-plot-"+t,console.log("Update-Dropdown y3",n),$(e.target).find("#"+n).css("color",e.y3.color)):void 0},t.prototype.appendStationMap=function(t,i,e,n){var o,a,s,r,l,p,d,h,u,c,f,m,y,g,v,x,b,w,P,D,T,S,_
for(o=this,_=this.uuid(),h="map-control-"+t,u='<li data-toggle="popover" data-placement="left"> <i id="map-'+t+'" class="icon-map-marker" style="cursor: pointer"></i> </li> <div class="popover" style="max-width: 356px;"> <div class="arrow"></div> <div class="popover-content"> <div id="'+h+'" style="width: 312px; height: 312px;"></div> </div> </div>',$(i).prepend(u),$("#map-"+t).on("click",function(){return o.plotter.controls.toggleMap(_)}),this.markers[_]=[],this.maps[_]=new google.maps.Map(document.getElementById(h),{center:new google.maps.LatLng(46.98,-121.98),zoom:6,mapTypeId:"terrain",zoomControl:!0,mapTypeControl:!1,scaleControl:!1,streetViewControl:!1,rotateControl:!1,fullscreenControl:!1}),f=new google.maps.InfoWindow({content:""}),s=new google.maps.LatLngBounds,a=[],c=0,g=e.length;g>c;c++)for(D=e[c],P=D.dataloggers,m=0,v=P.length;v>m;m++)S=P[m],d="rgb(200,200,200)",T=5,w=.5,p=o.isCurrent(n,"dataLoggerId",S.id),p&&(d=p.color,T=7,w=.8,a.push(new google.maps.LatLng(S.lat,S.lon))),b=new google.maps.Marker({position:{lat:S.lat,lng:S.lon},tooltip:S.datalogger_name+" - "+S.elevation+" ft",dataloggerid:S.id,icon:{path:google.maps.SymbolPath.CIRCLE,scale:T,strokeWeight:2,fillOpacity:w,fillColor:d},selected:!1}),b.addListener("mouseover",function(){return f.setContent(this.tooltip),f.open(o.maps[_],this)}),b.addListener("mouseout",function(){return f.close()}),b.addListener("click",function(){return o.plotter.addStation(t,this.dataloggerid)}),r=this.markers[_].push(b),this.markers[_][r-1].setMap(this.maps[_])
for(y=0,x=a.length;x>y;y++)l=a[y],s.extend(l)
return this.maps[_].fitBounds(s),this.maps[_].setZoom(12)},t.prototype.removeStationMap=function(t){return $("#map-control-"+t).empty()},t.prototype.toggleMap=function(t){var i,e,n
return e=$("#map-control-"+t).parent().parent().prev().offset(),$("#map-control-"+t).parent().parent().toggle().css("left",e.left-356).css("top",e.top),i=this.plotter.controls.maps[mapUuid].getCenter(),n=this.plotter.controls.maps[mapUuid].getZoom(),google.maps.event.trigger(this.plotter.controls.maps[mapUuid],"resize"),this.plotter.controls.maps[mapUuid].setCenter(i),this.plotter.controls.maps[mapUuid].setZoom(n)},t.prototype.toggle=function(t){return $(t).toggle()},t.prototype.move=function(t,i,e){var n,o
...
return i=this,o=this.uuid(),e='<ul id="new-'+o+'-dropdown" class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="new-'+o+'"> <li><a id="new-'+o+'-parameter" style="cursor: pointer">Add Parameter Plot</a></li> <li><a id="new-'+o+'-station" style="cursor: pointer">Add Station Plot</a></li> </ul>',n='<div class="dropdown"> <li><a id="new-'+o+'" role="button" href="#"> <i class="icon-plus"></i> </a></li> </div>',$(t).append(n),$("#new-"+o).on("click",function(){return i.plotter.add("parameter")})},t.prototype.uuid=function(){return(4294967296*(1+Math.random())|0).toString(16).substring(1)},t.prototype.isCurrent=function(t,i,e){var n,o
...
return-1}
window.Plotting||(window.Plotting={}),window.Plotting.Data=t=function(){function t(t){var i,e,n,o,a
...
for(this.data=$.extend(!0,[],t),this.sourceCount=1,i=this.data.length-1,e=n=0,a=i;a>=0?a>=n:n>=a;e=a>=0?++n:--n)void 0===this.data[e]&&console.log(o+" on construct, @data[i] is (i, row)",e,this.data[e])
this.test=function(t,i,e){var n,a,s,r,l,p
for(o=this.preError+"test(...):",a=e.length,n=0,l=!1,s=0,r=e.length;r>s;s++){if(p=e[s],void 0===t[p])throw new Error(o+" key '"+p+"' not found in primary data set.")
if(void 0===i[p])throw new Error(o+" key '"+p+"' not found in joining data set.")
t[p]instanceof Date?t[p].getTime()===i[p].getTime()&&n++:t[p]===i[p]&&n++}return n===a&&(l=!0),l}}return t.prototype.join=function(t,e){var n,o,a,s,r,l,p,d,h,u,c,f,m,y,g
m=this.preError+".join(data, onKeys)",y=[],s="_"+parseInt(this.sourceCount+1),l=Object.keys(this.data[0]),n=Object.keys(t[0]),t.length>this.data.length?(r=$.extend(!0,[],t),d=$.extend(!0,[],this.data)):(r=$.extend(!0,[],this.data),d=$.extend(!0,[],t))
for(f in r){g=r[f],a=y.push($.extend(!0,{},g))
for(o in d)if(p=d[o],u=this.test(g,p,e)){for(h in p)c=p[h],i.call(e,h)<0&&(y[a-1][h+s]=c)
d.splice(o,1)
break}}return this.sourceCount++,this.data=this._clean(y),this.data},t.prototype.merge=function(t,e){var n,o,a,s,r,l,p,d,h,u,c,f,m,y
f=this.preError+".merge(data, onKeys)",m=[],r=Object.keys(this.data[0]),n=Object.keys(t[0]),t.length>this.data.length?(s=$.extend(!0,[],t),p=$.extend(!0,[],this.data)):(s=$.extend(!0,[],this.data),p=$.extend(!0,[],t))
for(c in s){y=s[c],a=m.push($.extend(!0,{},y))
for(o in p)if(l=p[o],h=this.test(y,l,e)){for(d in l)u=l[d],i.call(e,d)<0&&(m[a-1][d]=u)
p.splice(o,1)
break}}return this.data=this._clean(m),this.data},t.prototype.append=function(t,e){var n,o,a,s,r,l,p,d,h,u,c
...
s.splice(n,1)}}return u=o.concat(s),this.data=this._clean(u),this.data},t.prototype.sub=function(t,i){return this.data=this._clean($.extend(!0,[],this.data.slice(t,i))),this.data},t.prototype.get=function(){return $.extend(!0,[],this.data)},t.prototype.getSourceCount=function(){return this.sourceCount},t.prototype._clean=function(t){var i,e,n,o,a
for(i=$.extend(!0,[],t),e=i.length-1,n=o=0,a=e;a>=0?a>=o:o>=a;n=a>=0?++o:--o)void 0===i[n]&&i.splice(n,1)
return $.extend(!0,[],i)},t.prototype._tryError=function(t,i){var e,n,o,a,s
for(e=t.length-1,s=[],n=o=0,a=e;a>=0?a>=o:o>=a;n=a>=0?++o:--o){if(void 0===t[n])throw console.log("@data[i] is (i, row)",n,row),new Error(i+" undefined row")
...
return i=this.processData(t),e=new Plotting.Data(this.data),e.append(i,["x"]),this.data=e._clean(e.get()),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized?(this.setDataState(),this.setIntervalState(),this.setDataRequirement()):void 0},t.prototype.setDataState=function(){var t,i,e,n
for(t=this.data.length-1,i=e=0,n=t;n>=0?n>=e:e>=n;i=n>=0?++e:--e)void 0===this.data[i]&&console.log("data[i] is (i, row)",i,this.data[i])
...
return t=0,i=this.template[t],e=i.proto.getState(),e.request.data.min&&this.prependData(t),e.request.data.max?this.appendData(t):void 0},t.prototype.listenTestLoop=function(){var t,i,e,n,o
e=this.template,n=[]
...
return o=this.preError+".getTemplate(...)",a="template/"+this.options.plotHandlerId,e=null,i=this,n=function(t){return null===t.responseJSON||t.responseJSON.error?void console.log(o+".callback(...) error detected (data)",t):i.template=t.responseJSON.templateData},this.syncronousapi.get(a,e,n)},t.prototype.putTemplate=function(){var t,i,e,n,o
return n=this.preError+".putTemplate()",o="template/"+this.options.plotHandlerId,i={templateId:this.options.templateId,templateData:this.template},t=this,e=function(t){return null===t.responseJSON||t.responseJSON.error?void console.log(n+".callback(...) error detected (data)",t):console.log(n+".callback() success saving template.")},this.api.put(o,i,e)},t.prototype.getStationParamData=function(t,i){var e,n,o,a,s
return a=this.preError+".getStationParamData()",s=location.protocol+"//dev.nwac.us/api/v5/measurement",e=this,n=this.template[t].dataParams[i],o=function(i){return void 0===e.template[t].data?e.template[t].data=[i.responseJSON.results]:e.template[t].data.push(i.responseJSON.results),console.log(a+" (template.data)",e.template[t].data)},this.syncronousapi.get(s,n,o)},t.prototype.getTemplatePlotData=function(){var t,i,e,n,o,a,s
...
for(r in d){if(l=d[r],u=this.utarget(this.options.target),$(this.options.target).append("<div id='"+u+"'></div>"),this.mergeTemplateOption(r),void 0===l.options.y2&&(l.options.y2={}),void 0===l.options.y3&&(l.options.y3={}),l.options.plotId=r,l.options.uuid=this.uuid(),l.options.target="#"+u,l.options.y.color=this.getColor("light",r),l.options.y2.color=this.getColor("light",parseInt(r+4)),l.options.y3.color=this.getColor("light",parseInt(r+6)),e=this.getVariableBounds(l.options.y.variable),e&&(l.options.y.min=e.min,l.options.y.max=e.max),"temperature"===l.options.y.variable&&(l.options.y.maxBarValue=32),i=new window.Plotting.Data(l.data[0]),n=l.data.length-1,n>0)for(o=s=1,h=n;h>=1?h>=s:s>=h;o=h>=1?++s:--s)i.join(l.data[o],[l.options.x.variable])
c=this.getTitle(l),a=new window.Plotting.LinePlot(this,i.get(),l.options),a.preAppend(),a.append(),this.template[r].proto=a,this.appendControls(r)}return $(this.options.target).append('<small><a style="cusor:pointer" id="save-'+u+'">Save Template</a></small>'),$("#save-"+u).on("click",function(i){return t.putTemplate()})},t.prototype.mergeTemplateOption=function(t){var i,e
return e=this.template[t],e.options.dataParams=e.dataParams,console.log("Merge Template Options (options)",e.options),i=e.options.dataParams.length,i>0&&(e.options.y.dataLoggerId=e.options.dataParams[0].data_logger),i>1&&(e.options.y2.dataLoggerId=e.options.dataParams[1].data_logger),i>2?e.options.y2.dataLoggerId=e.options.dataParams[2].data_logger:void 0},t.prototype.getAppendData=function(t,i,e){var n,o,a,s,r,l
return r=this.preError+".getAppendData(key, dataParams)",l="http://dev.nwac.us/api/v5/measurement",n=this,a=this.template[i].proto.options.dataParams[e],o=this.template[i].proto.options.dataParams.length,s=function(e){var a
return a=n.template[i],void 0===a.__data&&(a.__data=[]),void 0===a.__data[t]?a.__data[t]=new window.Plotting.Data(e.responseJSON.results):a.__data[t].join(e.responseJSON.results,[a.proto.options.x.variable]),a.__data[t].getSourceCount()===o?(a.proto.initialized?(a.proto.appendData(a.__data[t].get()),a.proto.update()):(a.proto.setData(a.__data[t].get()),a.proto.append()),delete a.__data[t]):void 0},this.api.get(l,a,s)},t.prototype.prependData=function(t){var i,e,n,o,a,s,r,l
a=this.preError+".prependData()",o=this.template[t],l=o.proto.getState(),i=this.uuid(),s=o.proto.options.dataParams,r=[]
for(n in s)e=s[n],o.proto.options.dataParams[n].max_datetime=this.format(l.range.data.min),o.proto.options.dataParams[n].limit=this.options.updateLength,r.push(this.getAppendData(i,t,n))
...
for(s in p)a=p[s],r.proto.options.dataParams[s].max_datetime=this.format(new Date(e)),r.proto.options.dataParams[s].limit=this.options.updateLength,d.push(this.getAppendData(o,t,s))
...
return this.controls.updateStationDropdown(t)},t.prototype.removeStation=function(t,i){return console.log("Remove Station (plotId, dataLoggerId)",t,i)},t.prototype.zoom=function(t){var i,e,n,o,a
for(o=this.template,a=[],i=0,e=o.length;e>i;i++)n=o[i],a.push(n.proto.setZoomTransform(t))
return a},t.prototype.crosshair=function(t,i){var e,n,o,a,s
for(a=this.template,s=[],e=0,n=a.length;n>e;e++)o=a[e],s.push(o.proto.setCrosshair(t,i))
return s},t.prototype.showCrosshairs=function(){var t,i,e,n,o
for(n=this.template,o=[],t=0,i=n.length;i>t;t++)e=n[t],o.push(e.proto.showCrosshair())
return o},t.prototype.hideCrosshairs=function(){var t,i,e,n,o
for(n=this.template,o=[],t=0,i=n.length;i>t;t++)e=n[t],o.push(e.proto.hideCrosshair())
...
if(this.template[this.template.length-1].proto.initialized!==!1)return console.log("Adding (type)",t,this.template),o=this.utarget(this.options.target),n={plotOrder:this.template.length,type:t},e={target:"#"+o,type:t,x:{variable:"datetime"}},a='<div id="'+o+'"></div>',$(this.options.target).append(a),i=this.template.push(n)-1,s=new window.Plotting.LinePlot(this,[],e),console.log("Instance ready for preAppend (_key, instance)",i,s),s.preAppend(),this.template[i].proto=s,this.template[i].proto.options.plotId=i,this.template[i].proto.initialized?this.appendControls(i):void 0},t.prototype.initVariable=function(t,i,e){return this.template[t].dataParams=[this.template[t-1].dataParams[0]],this.template[t].dataParams[0].data_logger=null,this.template[t].proto.options.y.variable=i,this.template[t].proto.options.y.title=e,this.appendControls(t),this.template[t].proto.removeTemp()},t.prototype.appendNew=function(t,i){var e
return e=this.template[t],console.log("Append new (plot)",e),e.dataParams[0].data_logger=i,e.proto.options.dataParams=e.dataParams,e.proto.options.y.dataloggerid=i,this.getAppendData(this.uuid(),t,0)},t.prototype.setNewOptions=function(t,i,e){var n,o
if(n=this.getVariableBounds(i),o=this.getVariableInfo(i),null===this.template[t].proto.options.y.variable){if(this.template[t].proto.options.y={dataLoggerId:e,variable:i,color:this.getColor("light",parseInt(t))},o&&(this.template[t].proto.options.y.title=o.title,this.template[t].proto.options.y.units=o.units),n)return this.template[t].proto.options.y.min=n.min,this.template[t].proto.options.y.max=n.max}else if(null===this.template[t].proto.options.y2.variable){if(this.template[t].proto.options.y2={dataLoggerId:e,variable:i,color:this.getColor("light",parseInt(t)+4)},o&&(this.template[t].proto.options.y2.title=o.title,this.template[t].proto.options.y2.units=o.units),n)return this.template[t].proto.options.y2.min=n.min,this.template[t].proto.options.y2.max=n.max}else if(null===this.template[t].proto.options.y3.variable&&(this.template[t].proto.options.y3={dataLoggerId:e,variable:i,color:this.getColor("light",parseInt(t)+6)},o&&(this.template[t].proto.options.y2.title=o.title,this.template[t].proto.options.y2.units=o.units),n))return this.template[t].proto.options.y3.min=n.min,this.template[t].proto.options.y3.max=n.max},t.prototype.getVariableBounds=function(t){var i
...
for(o=-1,n=a=0,s=t.length-1;s>=0?s>=a:a>=s;n=s>=0?++a:--a)t[n][i]===e&&(o=n)
