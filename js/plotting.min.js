...
e={dateFormat:"%Y-%m-%dT%H:%M:%SZ",timeFormat:"%Y-%m-%dT%H:%M:%SZ-08"},i=this.mergeDefaults(e,t),this.parseDate=d3.timeParse(i.dateFormat),this.format=d3.utcFormat(i.dateFormat),this.format2=d3.timeFormat(i.timeFormat),this.getNow=function(){return this.format(new Date)},this.getNow2=function(){return this.format2(new Date)}}return t.prototype.mergeDefaults=function(t,i){var e,n,s,o,r
s={}
