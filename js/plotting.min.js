...
return r},t.prototype.updateStationMap=function(t){var e,i,o,n,r,s,a,l,p
e=this,this.resetStationMap(t),p=function(t,i,o){return e.markers[t][i].setIcon({path:google.maps.SymbolPath.CIRCLE,scale:7,strokeWeight:2,fillOpacity:.8,fillColor:o}),e.markers[t][i].set("selected",!0),e.listeners[t][i].remove(),e.listeners[t][i]=e.markers[t][i].addListener("click",function(){var i
return i=this.get("dataLoggerId"),e.plotter.removeStation(t,i)})},o=this.plotter.plots[t].proto.options,s=o.y,a=[]
for(r in s)l=s[r],null!==l.variable?(i=l.variable.replace("_","-"),n="map-plot-"+t+"-station-"+l.dataLoggerId,a.push(p(t,n,l.color))):a.push(void 0)
return a},t.prototype.boundOnSelected=function(t){var e,i,o,n,r,s,a,l,p,d
...
if(n=-1,t.length>0)for(o=r=0,s=t.length-1;0<=s?r<=s:r>=s;o=0<=s?++r:--r)null!=t[o]&&t[o][e]==i&&(n=o)
...
if(i=this.processDataSet(t,e),o=new window.Plotter.Data(this.data[e]),o.append(i,["x"]),this.data[e]=o._clean(o.get()),this.data[e]=this.data[e].sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.removeData=function(t){if(t>=0&&(delete this.data[t],delete this.options[t],this.svg.select(".line-plot-area-"+t).remove(),this.svg.select(".line-plot-path-"+t).remove(),this.svg.select(".focus-circle-"+t).remove(),this.svg.select(".focus-text-"+t).remove(),this.initialized))return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.setDataState=function(){var t,e,i,o,n
t=this.data.length-1,i=this.data,o=[]
for(e in i)n=i[e],this.state.range.data[e]={min:d3.min(this.data[e],function(t){return t.x}),max:d3.max(this.data[e],function(t){return t.x})},o.push(this.state.length.data[e]=this.data[e].length)
return o},t.prototype.setIntervalState=function(){var t,e,i,o
e=this.data,i=[]
...
return this.overlay=this.svg.append("rect").attr("class","plot-event-target"),this.appendCrosshairTarget(this.transform),this.appendZoomTarget(this.transform)}},t.prototype.update=function(){var t,e,i,o,n,r
...
this.overlay.remove(),this.overlay=this.svg.append("rect").attr("class","plot-event-target"),this.appendCrosshairTarget(this.transform),this.appendZoomTarget(this.transform),this.calculateYAxisDims(this.data),this.definition.y.domain([this.definition.y.min,this.definition.y.max]).nice(),n=this.data
...
if(this.initialized){r=this.preError+".setZoomTransform(transform)",e=this,o=t?t:d3.event.transform,this.transform=t,i=o.rescaleX(this.definition.x),this.svg.select(".line-plot-axis-x").call(this.definition.xAxis.scale(i)),this.state.range.scale=this.getDomainScale(i),this.state.mean.scale=this.getDomainMean(i),this.setDataState(),this.setIntervalState(),this.setDataRequirement(),this.setZoomState(o.k),this.definition.area=d3.area().defined(function(t){return!isNaN(t.yMin)&&null!==t.yMin&&!isNaN(t.yMax)&&null!==t.yMax}).x(function(t){return o.applyX(e.definition.x(t.x))}).y0(function(t){return e.definition.y(t.yMin)}).y1(function(t){return e.definition.y(t.yMax)}),this.definition.line=d3.line().defined(function(t){return!isNaN(t.y)&&null!==t.y}).x(function(t){return o.applyX(e.definition.x(t.x))}).y(function(t){return e.definition.y(t.y)}),s=this.data
...
for(o in t)i=t[o],null!==i.variable?(null!=this.focusCircle[o]&&this.focusCircle[o].style("display",null).attr("fill",i.color),null!=this.focusText[o]?e.push(this.focusText[o].style("display",null).style("color",i.color).style("fill",i.color)):e.push(void 0)):e.push(void 0)
...
for(o in t)i=t[o],null!==i.variable?(null!=this.focusCircle[o]&&this.focusCircle[o].style("display","none"),null!=this.focusText[o]?e.push(this.focusText[o].style("display","none")):e.push(void 0)):e.push(void 0)
...
return o=new Date,i.range.data[0].max>=o||(s=this.plotter.lib.format(i.range.data[0].max),r=i.length.data[0],n=this.plotter.i.template.forSync(t,e,s,r),a=this.plotter.lib.uuid(),this.requests[a]={ready:!1,requested:!1},this.requests[a].requested=this.getNew(t,e,a,n))},t.prototype.get=function(t,e,i,o,n){var r,s,a,l
...
return r.addData(a,e),r.update(),n.requests[i].ready=!0,n.plotter.i.controls.removeSpinner(t),n.plotter.updates=n.plotter.updates<0?0:n.plotter.updates-1},this.api.get(a,o,r),!0},t}()}.call(this),function(){var t
...
t=this,o=this.plots
for(i in o)n=o[i],n.uuid=this.lib.uuid(),$(this.options.target).append('<div id="outer-'+n.uuid+'"></div>'),e=this.i.template.forPlots(i),e=this.i.colors.getInitial(e),e.target="#outer-"+n.uuid,e.uuid=n.uuid,n.proto=new window.Plotter.LinePlot(this,n.__data__,e),n.proto.preAppend(),n.proto.append(),this.i.controls.append(i)
return this.appendSave()},t.prototype.remove=function(t){return $(this.plots[t].proto.options.target).fadeOut(500,function(){return $(this).remove()}),this.i.template.removePlot(t),delete this.plots[t]},t.prototype.move=function(t,e){var i,o,n,r,s,a
...
return r=this.lib.uuid(),i="outer-"+r,n={plotOrder:this.i.template.plotCount()+1,type:t,target:"#"+i,y:[]},o='<div id="'+i+'"></div>',$(this.options.target).append(o),e=this.i.template.add(n),this.plots[e]={},this.plots[e].proto=new window.Plotter.LinePlot(this,[[]],n),this.plots[e].proto.preAppend(),this.plots[e].proto.options.plotId=e,this.plots[e].proto.options.uuid=r,this.appendSave()},t.prototype.initializePlot=function(t,e,i){var o,n
return n=this.i.specs.getOptions(e,null),this.i.template.template[t].x=$.extend(!0,{},this.i.template.template[0].x),this.i.template.template[t].y=[n],o=this.i.template.forPlots(t),this.plots[t].proto.options.x=o.x,this.plots[t].proto.options.y=o.y,this.i.controls.append(t),this.plots[t].proto.removeTemp()},t.prototype.addStation=function(t,e){var i,o,n,r
...
return e={battery_voltage:{min:8,max:16,maxBar:null},net_solar:{min:0,max:800,maxBar:null},relative_humidity:{min:0,max:102,maxBar:null},snow_depth:{min:0,max:40,maxBar:null},snowfall_24_hour:{min:0,max:40,maxBar:null},wind_direction:{min:0,max:360,maxBar:null},precipitation:{min:0,max:.7,maxBar:null},temperature:{min:0,max:60,maxBar:32},wind_speed_average:{min:0,max:60,maxBar:null}},e[t]},t.prototype.getVariableInfo=function(t){var e
return e={battery_voltage:{title:"Battery Voltage",units:"V"},net_solar:{title:"Solar Radiation",units:"W/m2"},relative_humidity:{title:"Relative Humidity",units:"%"},barometric_pressure:{title:"Barometric Pressure",units:"atm"},snow_depth:{title:"Snow Depth",units:'"'},snowfall_24_hour:{title:"24-Hour Snowfall",units:'"'},wind_direction:{title:"Wind Direction",units:"°"},precipitation:{title:"Precipitation",units:'"'},temperature:{title:"Temperature",units:"°F"},wind_speed_average:{title:"Wind Speed",units:"mph"}},e[t]},t}()}.call(this),function(){var t
...
for(e=0,o=t.length;e<o;e++)if(s=t[e],null!=s){if(void 0===s.type)return!1
...
for(e=0,i=t.length;e<i;e++)if(o=t[e],null!=o&&void 0===o.type)return!1
