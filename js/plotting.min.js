...
for(s in t)r=t[s],o[s]={x:new Date(this.parseDate(r[this.options.x.variable]).getTime()),y:r[n.variable]},null!=n.band&&(n.band.minVariable&&(o[s].yMin=r[n.band.minVariable]),n.band.maxVariable&&(o[s].yMax=r[n.band.maxVariable]))
...
return this.appendCrosshairTarget(n),n}},t.prototype.setCrosshair=function(t,i){var e,n,s,o,r,a,l,p,d,h,u,c,f,m,g,y,x,v,w
if(this.initialized){g=this.preError+".setCrosshair(mouse)",e=this,o=this.definition.dimensions,p=function(t){switch(!1){case!(t>360||t<0):return"INV"
...
case!(t>=348.75&&t<=360):return"N"}},y=this.data
for(m in y)x=y[m],r=this.overlay.node(),s=x,i=i?i:d3.mouse(r),w=this.definition.x.invert(i[0]+o.leftPadding),t&&(w=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),f=e.bisectDate(s,w,1),c=w.getMinutes()>=30?f:f-1,w.getTime()<=this.state.range.data[m].min.getTime()&&(c=f),w.getTime()>=this.state.range.data[m].max.getTime()&&(c=f-1),null!=s[c]&&(d=t?t.applyX(this.definition.x(s[c].x)):this.definition.x(s[c].x),h=[],a=[],null!==this.options.y[m].variable&&(a[m]=s[c],null!=a[m]&&(h[m]=this.definition.y(a[m].y),n=this.displayDate(a[m].x),isNaN(h[m])||null==a[m].y||this.focusRect[m].attr("transform","translate(0, 0)"))),l=d-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),u=l-120,l<150&&(u=l+10),this.focusDateText.attr("x",u).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n),null===this.options.y[m].variable||isNaN(h[m])||null==a[m].y||(this.focusRect[m].attr("width",t.k*this.definition.x1.bandwidth()).attr("x",d).attr("y",h[m]),v="start",d+80>this.definition.dimensions.width&&(d-=14,v="end"),this.focusText[m].attr("x",d+o.leftPadding/10+t.k*this.definition.x1.bandwidth()+2).attr("y",h[m]-o.topPadding/10).attr("text-anchor",v).text(null!=a[m].y?"wind_direction"===e.options.y[0].variable?p(a[m].y):a[m].y.toFixed(this.options.decimals)+" "+this.options.y[m].units:void 0))))
...
return a=this.plotter.options.href+"/api/v5/dataloggerregion?sensor_name="+e,n=this,s={},r=this.getCurrent(t),l=this.plotter.lib.uuid(),o=function(e){var s,o,r,a,p,d,h,u,c,f
...
o+=" </ul>"}return o+=" </ul> </li>",$(i).prepend(o),$("#station-"+l).dropdown(),n.bindSubMenuEvent(".subheader"),n.setCurrent(t),n.updateStationDropdown(t),n.appendStationMap(t,i,e.responseJSON.results)},this.api.get(a,s,o)},t.prototype.updateStationDropdown=function(t){var i,e,n,s,o,r,a,l,p,d,h,u,c,f,m
...
return l=this.plotter.options.href+"/api/v5/sensortype?sensors__data_logger="+n,o={},a=this.getCurrent(t),p=this.plotter.lib.uuid(),s=[],r=function(n){var s,o,r,l,d,h,u,c,f,m
...
return l+=" </ul> </li> </div>",$(e).prepend(l),$("#"+p).dropdown()},this.api.get(l,o,r)},t.prototype.appendStationMap=function(t,i,e){var n,s,o,r,a,l,p,d,h,u,c,f,m,g,y,x,v,w,b,S,P,D,T,_
for(n=this,u=this.getCurrent(t),d=this.plotter.plots[t].proto.options.uuid,c='<li data-toggle="popover" data-placement="left"> <i id="map-'+d+'" class="icon-map-marker" title="Select Stations Map" style="cursor: pointer"></i> </li> <div class="popover" style="max-width: 356px;"> <div class="popover-content"> <a id="map-close-'+d+'" style="font-size: 10px; cursor: pointer">Close</a> <div id="map-control-'+d+'" style="width: 312px; height: 312px;"></div> </div> </div>',$(i).prepend(c),$("#map-"+d).on("click",function(){return n.plotter.i.controls.toggleMap(t)}),$("#map-close-"+d).on("click",function(){return n.plotter.i.controls.toggleMap(t)}),this.maps[t]=new google.maps.Map(document.getElementById("map-control-"+d),{center:new google.maps.LatLng(46.98,-122.221),zoom:6,maxZoom:12,minZoom:6,mapTypeId:"terrain",zoomControl:!0,mapTypeControl:!1,scaleControl:!1,streetViewControl:!1,rotateControl:!1,fullscreenControl:!1}),m=new google.maps.InfoWindow({content:"",disableAutoPan:!0}),this.markers[t]=[],this.listeners[t]=[],o=new google.maps.LatLngBounds,s=[],f=0,x=e.length;f<x;f++)for(D=e[f],P=D.dataloggers,g=0,v=P.length;g<v;g++)_=P[g],h="rgb(200,200,200)",T=5,S=.5,p="map-plot-"+d+"-station-"+_.id,l=n.isCurrent(u,"dataLoggerId",_.id),l&&(h=l.color,T=7,S=.8,s.push(new google.maps.LatLng(_.lat,_.lon))),b=new google.maps.Marker({position:{lat:_.lat,lng:_.lon},id:p,tooltip:_.datalogger_name+" - "+_.elevation+" ft",dataLoggerId:_.id,icon:{path:google.maps.SymbolPath.CIRCLE,scale:T,strokeWeight:2,fillOpacity:S,fillColor:h},selected:!1}),b.addListener("mouseover",function(){return m.setContent(this.tooltip),m.open(n.maps[t],this)}),b.addListener("mouseout",function(){return m.close()}),this.listeners[t][p]=b.addListener("click",function(){return n.plotter.addStation(t,this.dataLoggerId)}),r=this.markers[t][p]=b,this.markers[t][p].setMap(this.maps[t])
...
return o},t.prototype.updateStationMap=function(t){var i,e,n,s,o,r,a,l,p,d
i=this,o=this.plotter.plots[t].proto.options.uuid,this.resetStationMap(t),d=function(t,e,n){return i.markers[t][e].setIcon({path:google.maps.SymbolPath.CIRCLE,scale:7,strokeWeight:2,fillOpacity:.8,fillColor:n}),i.markers[t][e].set("selected",!0),i.listeners[t][e].remove(),i.listeners[t][e]=i.markers[t][e].addListener("click",function(){var e
return e=this.get("dataLoggerId"),i.plotter.removeStation(t,e)})},n=this.plotter.plots[t].proto.options,a=n.y,l=[]
for(r in a)p=a[r],null!==p.variable?(e=p.variable.replace("_","-"),s="map-plot-"+o+"-station-"+p.dataLoggerId,l.push(d(t,s,p.color))):l.push(void 0)
return l},t.prototype.boundOnSelected=function(t){var i,e,n,s,o,r,a,l,p,d
...
return e=this,n=this.plotter.plots[t].proto.options.uuid,s='<i id="remove-'+n+'" style="cursor: pointer;" title="Remove Plot" class="icon-remove"></i>',$(i).append(s),$("#remove-"+n).on("click",function(){return e.plotter.remove(t)})},t.prototype.new=function(t){var i,e,n,s,o,r,a,l,p,d,h
...
if(this.initialized=!0,this.initialized){o=this.preError+"append()",t=this,this.svg.select(".line-plot-axis-x").call(this.definition.xAxis),this.svg.select(".line-plot-axis-y").call(this.definition.yAxis),e=""+this.options.y[0].title,this.options.y[0].units&&(e=e+" "+this.options.y[0].units),n=-this.definition.dimensions.margin.top,i=-this.definition.dimensions.margin.left,this.svg.select(".line-plot-axis-y").append("text").text(e).attr("fill",this.options.axisColor).attr("class","line-plot-y-label").attr("x",n).attr("y",i).attr("dy",".75em").attr("transform","rotate(-90)").style("font-size",this.options.font.size).style("font-weight",this.options.font.weight),this.lineWrapper=this.svg.append("g").attr("class","line-wrapper"),r=this.data
...
for(s in a)l=a[s],this.focusCircle[s]=this.hoverWrapper.append("circle").attr("r",4).attr("class","focus-circle-"+s).attr("fill",this.options.y[s].color).attr("transform","translate(-10, -10)").style("display","none"),this.focusText[s]=this.hoverWrapper.append("text").attr("class","focus-text focus-text-"+s).attr("x",9).attr("y",7).style("display","none").style("fill",this.options.y[s].color).style("text-shadow","-2px -2px 0 rgb(255,255,255), 2px -2px 0 rgb(255,255,255), -2px 2px 0 rgb(255,255,255), 2px 2px 0 rgb(255,255,255)")
...
return this.appendCrosshairTarget(n),n}},t.prototype.setCrosshair=function(t,i){var e,n,s,o,r,a,l,p,d,h,u,c,f,m,g,y,x,v,w,b
if(this.initialized){g=this.preError+".setCrosshair(mouse)",e=this,o=this.definition.dimensions,p=function(t){switch(!1){case!(t>360||t<0):return"INV"
case!(t>=0&&t<11.25):return"N"
case!(t>=11.25&&t<33.75):return"NNE"
case!(t>=33.75&&t<56.25):return"NE"
...
case!(t>=326.25&&t<348.75):return"NNW"
case!(t>=348.75&&t<=360):return"N"}},y=this.data
for(m in y)x=y[m],r=this.overlay.node(),s=x,i=i?i:d3.mouse(r),w=this.definition.x.invert(i[0]+o.leftPadding),t&&(w=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),f=e.bisectDate(s,w,1),c=w.getMinutes()>=30?f:f-1,w.getTime()<=this.state.range.data[m].min.getTime()&&(c=f),w.getTime()>=this.state.range.data[m].max.getTime()&&(c=f-1),null!=s[c]&&(d=t?t.applyX(this.definition.x(s[c].x)):this.definition.x(s[c].x),h=[],a=[],null!==this.options.y[m].variable&&(a[m]=s[c],null!=a[m]&&(h[m]=this.definition.y(a[m].y),n=this.displayDate(a[m].x),isNaN(h[m])||null==a[m].y||this.focusCircle[m].attr("transform","translate(0, 0)"))),l=d-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),u=l-120,l<150&&(u=l+10),this.focusDateText.attr("x",u).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n),null===this.options.y[m].variable||isNaN(h[m])||null==a[m].y||(this.focusCircle[m].attr("cx",d).attr("cy",h[m]),v="start",d+80>this.definition.dimensions.width&&(d-=14,v="end"),this.focusText[m].attr("x",d+o.leftPadding/10).attr("y",h[m]-o.topPadding/10).attr("text-anchor",v).text(a[m].y?"wind_direction"===e.options.y[0].variable?p(a[m].y):a[m].y.toFixed(this.options.decimals)+" "+this.options.y[m].units:void 0))))
return void 0!==this.options.y[1]&&(b=[],this.svg.selectAll(".focus-text").attr("transform",function(t,i){return x={ind:i,y:parseInt(d3.select(this).attr("y")),offset:0},b.push(x),""}).call(function(t){return b.sort(function(t,i){return t.y-i.y}),b.forEach(function(t,i){var e,n
if(i>0)return n=0,b[i].y<b[i-1].y+b[i-1].offset&&(n=b[i-1].y+b[i-1].offset-b[i].y),e=Math.max(0,b[i-1].y+b[i-1].offset+18-(b[i].y+n)),b[i].offset=e+n})}).attr("transform",function(t,i){var n
return n=e.plotter.lib.indexOfValue(b,"ind",i),"translate (0, "+b[n].offset+")"})),i}},t.prototype.showCrosshair=function(){var t,i,e,n
if(this.initialized){this.crosshairs.select(".crosshair-x").style("display",null),this.crosshairs.select(".crosshair-x-under").style("display",null),this.focusDateText.style("display",null),t=this.options.y,i=[]
...
return this.bandDomain=this.plots[0].proto.definition.x1,this.appendSave(),this.appendPoweredBy()},t.prototype.appendLoading=function(){return $(this.options.target).append('<div class="plotter-loading" style="text-align: center; "> <span> <i class="icon-spinner icon-spin icon-large"></i> Loading Plots... </span> </div>')},t.prototype.removeLoading=function(){return $(this.options.target).find(".plotter-loading").remove()},t.prototype.remove=function(t){return $(this.plots[t].proto.options.target).fadeOut(500,function(){return $(this).remove()}),this.i.template.removePlot(t),delete this.plots[t]},t.prototype.move=function(t,i){var e,n,s,o,r,a
if(o=this.i.template.template,n=o[t],e=n.pageOrder,a=$(this.plots[t].proto.options.target),"up"===i){if(e>1)return r=this.lib.indexOfValue(o,"pageOrder",e-1),s=o[r],n.pageOrder--,s.pageOrder++,a.prev().insertAfter(a)}else if("down"===i&&e<o.length)return r=this.lib.indexOfValue(o,"pageOrder",e+1),s=o[r],n.pageOrder++,s.pageOrder--,a.next().insertBefore(a)},t.prototype.add=function(t,i){var e,n,s,o,r,a,l,p,d,h,u,c,f
for(f=this.lib.uuid(),r="outer-"+f,h={pageOrder:this.i.template.plotCount()+1,type:t,target:"#"+r,requestInterval:this.options.requestPaddingInterval,y:[]},l='<div id="'+r+'"></div>',$(this.options.target).append(l),n=this.i.template.add(h),this.plots[n]={},s=this.i.specs.getPlotType(i),"precipitation_line"===i&&(i="precipitation",s="line"),e=this.i.specs.getPlotDecimals(i),console.log("New Plot (variable, decimals): ",i,e),"bar"===s?this.plots[n].proto=new window.Plotter.BarPlot(this,[[]],h):this.plots[n].proto=new window.Plotter.LinePlot(this,[[]],h),this.plots[n].proto.preAppend(),this.plots[n].proto.options.plotType=s,this.plots[n].proto.options.plotId=n,this.plots[n].proto.options.uuid=f,this.plots[n].proto.options.decimals=e,this.appendSave(),a=this.i.specs.getOptions(i,null),u=this.i.template.template,p=0,d=u.length;p<d;p++)if(c=u[p],void 0!==c){this.i.template.template[n].x=$.extend(!0,{},c.x)
break}return this.i.template.template[n].y=[a],o=this.i.template.forPlots(n),this.plots[n].proto.options.x=o.x,this.plots[n].proto.options.y=o.y,this.i.controls.append(n)},t.prototype.addStation=function(t,i){var e,n,s,o
...
return e=": Last Saved: "+t.lib.getNowDisplay(),"Save Graph"===$("#save-"+t.options.localId).html()?this.append(e):$("#save-"+t.options.localId).html("Save Graph"+e),t.i.template.put()})},t.prototype.appendPoweredBy=function(){return $(this.options.target).parent().append('<p style="font-size: 11px; font-weight: 300">Powered by Air Sciences Inc. | <a href="http://airsci.com">www.airsci.com</a></p>')},t}()}.call(this),function(){var t
...
default:return"line"}},t.prototype.getPlotDecimals=function(t){switch(t){case"precipitation":return 2
default:return 1}},t}()}.call(this),function(){var t
...
if(i=JSON.parse(t).templateData,this.isValid(i)){for(o=!1,n=e=s=i.length-1;s<=0?e<=0:e>=0;n=s<=0?++e:--e)r=i[n],null!=r?(r.x.min=new window.Plotter.Now(this.plotter.lib.format,r.x.min).get(),r.x.max=new window.Plotter.Now(this.plotter.lib.format,r.x.max).get(),r.y=this.spliceArrayY(r.y)):(o=!0,i.splice(n,1))
...
return t},t.prototype.spliceArrayY=function(t){var i,e,n
for(e=i=n=t.length-1;n<=0?i<=0:i>=0;e=n<=0?++i:--i)null==t[e]&&t.splice(e,1)
