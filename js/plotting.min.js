...
console.log("Re-appending overlay (transform)",this.transform),this.overlay.remove(),this.overlay=this.svg.append("rect").attr("class","plot-event-target"),this.appendCrosshairTarget(this.transform),this.appendZoomTarget(this.transform),this.calculateYAxisDims(this.data),this.definition.y.domain([this.definition.y.min,this.definition.y.max]).nice(),n=this.data
...
i=this.plots,o=[]
for(e in i)n=i[e],n.uuid=this.lib.uuid(),$(this.options.target).append('<div id="outer-'+n.uuid+'"></div>'),t=this.i.template.forPlots(e),t=this.i.colors.getInitial(t),t.target="#outer-"+n.uuid,t.uuid=n.uuid,n.proto=new window.Plotter.LinePlot(this,n.__data__,t),n.proto.preAppend(),n.proto.append(),o.push(this.i.controls.append(e))
