...
if(t=this,$("#save-"+this.options.localId).parent().remove(),this.isAdmin()||null!=this.options.uuid)return $(this.options.target).append('<small><a style="cusor:pointer" id="save-'+this.options.localId+'">Save Template</a></small>'),$("#save-"+this.options.localId).on("click",function(i){return t.i.template.put()})},t}()}.call(this),function(){var t
...
return s=this.endpoint()+(""+this.plotter.options.templateId),console.log("PUT Target Test: ",s),i={template_data:this.stringify(this.template)},t=this,e=function(t){return console.log("Template PUT completed (data)",t)},this.api.put(s,i,e)},t.prototype.add=function(t){var i,e,n
