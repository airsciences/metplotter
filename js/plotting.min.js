...
else try{e=new ActiveXObject("Msxml2.XMLHTTP")}catch(o){t=o
try{e=new ActiveXObject("Microsoft.XMLHTTP")}catch(e){t=e,console.error(i,"Cannot specify XMLHTTPRequest (error)",t)}}return e},t.prototype.get=function(t,i,e){var o,n,a
n=this.preError+".get(uri, params, callback)",a=this.build(),"undefined"!=typeof e&&(a.onreadystatechange=function(){var t,i
if(4===a.readyState){if(200!==a.status&&304!==a.status)return console.log(n+" HTTP error, (status): "+a.status),void(a=null)
...
try{a.open("GET",t+i,this.async),a.setRequestHeader("Authorization",this.getAccessTokenValue()),a.send(null)}catch(t){o=t,console.log(n+"catch(error).",o)}},t.prototype.put=function(){var t,i,e,o
e=this.preError+".put(uri, params, callback)",o=this.build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(e+" HTTP error, (status): "+o.status),void(o=null)
...
try{o.open("PUT",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(t){i=t,console.log(e+"catch(error).",i)}},t.prototype.post=function(){var t,i,e,o
e=this.preError+".post(uri, params, callback)",o=build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(e+" HTTP error, (status): "+o.status),void(o=null)
i={response:o.response,responseText:o.responseText,responseJSON:null}
try{i.responseJSON=JSON.parse(i.responseText)}catch(e){t=e,i.responseJSON=null}return callback(i)}}),t=this.encodeArgs("POST",t)
try{o.open("POST",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(t){i=t,console.log(e+"catch(error).",i)}},t.prototype.delete=function(){var t,i,e,o
e=this.preError+".delete(uri, params, callback)",o=this.build(),"undefined"!=typeof callback&&(o.onreadystatechange=function(){var t,i
if(4===o.readyState){if(200!==o.status&&304!==o.status)return console.log(e+" HTTP error, (status): "+o.status),void(o=null)
i={response:o.response,responseText:o.responseText,responseJSON:null}
...
try{o.open("DELETE",uri,this.async),o.setRequestHeader("Authorization",this.getAccessToken()),o.setRequestHeader("Content-Type","application/json;charset=UTF-8"),o.send(t)}catch(t){i=t,console.log(e+"catch(error).",i)}},t.prototype.encodeArgs=function(t,i){var e,o,n,a,s
if(s=this.preError+"encodeArgs(type, json_args)",o="",e=0,"string"==typeof i)try{i=JSON.parse(i)}catch(t){a=t,console.log(s+"catch(error).",a)}if("POST"===t||"PUT"===t)o=JSON.stringify(i)
...
for(console.log("Append station dropdown (data)",e),f='<div class="dropdown"> <li><a id="'+l+'" class="station-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="station-dropdown-'+t+'" class="dropdown-menu pull-right">',n.stations[t]=e.responseJSON.results,_=e.responseJSON.results,m=0,b=_.length;m<b;m++){for(I=_[m],u="",k="",a='<span class="station-dots">',p=0,M=I.dataloggers,g=0,w=M.length;g<w;g++)h=M[g],d=n.isCurrent(o,"dataLoggerId",h.id),d&&(p++,a=a+' <i class="icon-circle" style="color: '+d.color+'"></i>')
for(p>0&&(k='style="background-color: rgb(248,248,248)"',u='style="font-weight: 700"'),f=f+' <li class="subheader" '+k+"> <a "+u+' href="#"><i class="icon-caret-down" style="margin-right: 6px"></i> '+I.name+" "+a+'</span></a> </li> <ul class="list-group-item sublist" style="display: none;">',C=I.dataloggers,v=0,P=C.length;v<P;v++)A=C[v],d=n.isCurrent(o,"dataLoggerId",A.id),c="",d&&(c='style="color: '+d.color+'"'),y="data-logger-"+A.id+"-plot-"+t,r='<i id="'+y+'" class="icon-circle" '+c+"></i>",s="add-station-"+t+"-"+A.id,f=f+' <li class="station" id="'+s+'" data-station-id="'+A.id+'" data-plot-id="'+t+'" style="padding: 1px 5px; cursor: pointer; list-style-type: none" onclick=""> '+r+" "+A.datalogger_name+" | "+A.elevation+" ft</li>"
f+=" </ul>"}for(f+=" </ul> </li>",$(i).prepend(f),O=e.responseJSON.results,x=0,D=O.length;x<D;x++)for(I=O[x],N=I.dataloggers,T=0,S=N.length;T<S;T++)A=N[T],s="add-station-"+t+"-"+A.id,$("#"+s).off("click").on("click",function(t){var i,e
return t.stopPropagation(),i=$(this).attr("data-plot-id"),e=$(this).attr("data-station-id"),n.plotter.addStation(i,e)})
return $("#"+l).dropdown(),n.bindSubMenuEvent(".subheader"),n.appendStationMap(t,i,e.responseJSON.results,o)},console.log("Calling station dropdown, (target, args)",r,a),this.api.get(r,a,s)},t.prototype.resetStationDropdown=function(t){var i,e,o,n,a,s,r,l
for(i=this,a=this.stations[t],r=[],o=0,n=a.length;o<n;o++)s=a[o],r.push(function(){var o,n,a,r
for(a=s.dataloggers,r=[],o=0,n=a.length;o<n;o++)l=a[o],e="add-station-"+t+"-"+l.id,console.log("Reset Station (color)",$("#"+e).find("i.icon-circle").css("color")),$("#"+e).find("i.icon-circle").css("color",""),r.push($("#"+e).off("click").on("click",function(t){var e,o
...
return t.stopPropagation(),o=$(this).attr("data-plot-id"),n=$(this).attr("data-station-id"),i.plotter.removeStation(o,n),e="circle-plot"+o+"-station"+n,$("#"+e).remove()})),null!==a.y3.variable)return n=a.y3.dataLoggerId,o="circle-plot"+t+"-station"+n,e=' <i class="icon-circle" id="'+o+'" style="color: '+a.y3.color+'"></i>',s="data-logger-"+n+"-plot-"+t,0===$("#"+o).length&&$(a.target).find("#"+s).css("color",a.y3.color).parent().parent().prev().css("background-color","rgb(248,248,248)").css("font-weight",700).children(":first").append(e),$("#add-station-"+t+"-"+n).off("click").on("click",function(t){var e,o,n
return t.stopPropagation(),o=$(this).attr("data-plot-id"),n=$(this).attr("data-station-id"),i.plotter.removeStation(o,n),e="circle-plot"+o+"-station"+n,$("#"+e).remove()})},t.prototype.appendParameterDropdown=function(t,e,o,n){var a,s,r,l,p
...
for(l=0,p=e.length;l<p;l++)s=e[l],o.extend(s)
if(this.maps[t].fitBounds(o),this.maps[t].getZoom()<6)return this.maps[t].setZoom(6)},t.prototype.toggleMap=function(t){var i,e,o,n,a
...
for(this.data=$.extend(!0,[],t),this.sourceCount=1,i=this.data.length-1,e=o=0,a=i;0<=a?o<=a:o>=a;e=0<=a?++o:--o)void 0===this.data[e]&&console.log(n+" on construct, @data[i] is (i, row)",e,this.data[e])
this.test=function(t,i,e){var o,a,s,r,l,p
for(n=this.preError+"test(...):",a=e.length,o=0,l=!1,s=0,r=e.length;s<r;s++){if(p=e[s],void 0===t[p])throw new Error(n+" key '"+p+"' not found in primary data set.")
...
for(i=$.extend(!0,[],t),e=i.length-1,o=n=0,a=e;0<=a?n<=a:n>=a;o=0<=a?++n:--n)void 0===i[o]&&i.splice(o,1)
return $.extend(!0,[],i)},t.prototype._tryError=function(t,i){var e,o,n,a,s
for(e=t.length-1,s=[],o=n=0,a=e;0<=a?n<=a:n>=a;o=0<=a?++n:--n){if(void 0===t[o])throw console.log("@data[i] is (i, row)",o,row),new Error(i+" undefined row")
...
if(i=this.processData(t),e=new Plotting.Data(this.data),e.append(i,["x"]),this.data=e._clean(e.get()),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.removeData=function(t){var i,e,o,n,a
a=[],n=this.data
for(e in n)o=n[e],delete o[t],a[e]=o
if(i=new Plotting.Data(a),this.data=i.get(),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.setDataState=function(){var t,i,e,o
for(t=this.data.length-1,i=e=0,o=t;0<=o?e<=o:e>=o;i=0<=o?++e:--e)void 0===this.data[i]&&console.log("data[i] is (i, row)",i,this.data[i])
...
if(t=0,i=this.template[t],e=i.proto.getState(),e.request.data.min&&this.prependData(t),e.request.data.max)return this.appendData(t)},t.prototype.listenTestLoop=function(){var t,i,e,o,n
e=this.template,o=[]
...
return n=this.preError+".getTemplate(...)",a=this.options.href+"/api/v5/plothandler/"+this.options.plotHandlerId,e=null,i=this,o=function(t){var e,o
if(null===t.responseJSON||t.responseJSON.error)return void console.log(n+".callback(...) error detected (data)",t)
try{e=JSON.parse(t.responseJSON.template_data),i.template=e.templateData}catch(t){o=t,console.log(n+".callback(...) JSON.parse error",o)}return i.parseDates(i.template)},this.syncronousapi.get(a,e,o)},t.prototype.parseDates=function(t){var i,e,o,n,a,s,r,l,p,d
for(i=this,s=function(t){var e,o
return t.includes("now")&&(o=new Date,t.includes("(")&&(e=parseInt(t.replace("(","").replace(")","").replace("now","")),o=new Date(o.getTime()+36e5*e)),t=i.format(o)),t},l=[],e=0,n=t.length;e<n;e++){for(p=t[e],r=p.dataParams,o=0,a=r.length;o<a;o++)d=r[o],d.max_datetime=s(d.max_datetime)
...
for(r in d){if(l=d[r],u=this.utarget(this.options.target),$(this.options.target).append("<div id='"+u+"'></div>"),this.mergeTemplateOption(r),void 0===l.options.y2&&(l.options.y2={}),void 0===l.options.y3&&(l.options.y3={}),l.options.plotId=r,l.options.uuid=this.uuid(),l.options.target="#"+u,l.options.y.color=this.getColor("light",r),l.options.y2.color=this.getColor("light",parseInt(r+4)),l.options.y3.color=this.getColor("light",parseInt(r+6)),e=this.getVariableBounds(l.options.y.variable),e&&(l.options.y.min=e.min,l.options.y.max=e.max),"temperature"===l.options.y.variable&&(l.options.y.maxBarValue=32),i=new window.Plotting.Data(l.data[0]),o=l.data.length-1,o>0)for(n=s=1,h=o;1<=h?s<=h:s>=h;n=1<=h?++s:--s)i.join(l.data[n],[l.options.x.variable])
...
if(e=this.template[t],e.options.dataParams=e.dataParams,i=e.options.dataParams.length,i>0&&(e.options.y.dataLoggerId=e.options.dataParams[0].data_logger),i>1&&(e.options.y2.dataLoggerId=e.options.dataParams[1].data_logger),i>2)return e.options.y2.dataLoggerId=e.options.dataParams[2].data_logger},t.prototype.getAppendData=function(t,i,e){var o,n,a,s,r,l
...
if(a=o.template[i],void 0===a.__data&&(a.__data=[]),void 0===a.__data[t]?a.__data[t]=new window.Plotting.Data(e.responseJSON.results):a.__data[t].join(e.responseJSON.results,[a.proto.options.x.variable]),a.__data[t].getSourceCount()===n&&(a.proto.initialized?(a.proto.appendData(a.__data[t].get()),a.proto.update()):(a.proto.setData(a.__data[t].get()),a.proto.append()),delete a.__data[t]),o.updates--,o.updates<0)return console.log("Unopened request closed (@updates)!",o.updates)},this.api.get(l,a,s)},t.prototype.prependData=function(t){var i,e,o,n,a,s,r,l
...
for(n=this.template,a=[],i=0,e=n.length;i<e;i++)o=n[i],a.push(o.proto.setZoomTransform(t))
return a},t.prototype.crosshair=function(t,i){var e,o,n,a,s
for(a=this.template,s=[],e=0,o=a.length;e<o;e++)n=a[e],s.push(n.proto.setCrosshair(t,i))
return s},t.prototype.showCrosshairs=function(){var t,i,e,o,n
for(o=this.template,n=[],t=0,i=o.length;t<i;t++)e=o[t],n.push(e.proto.showCrosshair())
return n},t.prototype.hideCrosshairs=function(){var t,i,e,o,n
for(o=this.template,n=[],t=0,i=o.length;t<i;t++)e=o[t],n.push(e.proto.hideCrosshair())
...
for(n=-1,o=a=0,s=t.length-1;0<=s?a<=s:a>=s;o=0<=s?++a:--a)t[o][i]===e&&(n=o)
