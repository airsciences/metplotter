...
return i=new Date(d3.mean(t.domain())),i.setHours(i.getHours()+Math.round(i.getMinutes()/60)),i.setMinutes(0),i.setSeconds(0),i.setMilliseconds(0),i},t.prototype.getDefinition=function(){var t,i,e,n
return n=this.preError+"getDefinition():",t=this,this.definition={},this.calculateChartDims(),this.calculateAxisDims(this.data),this.definition.xAxis=d3.axisBottom().scale(this.definition.x).ticks(Math.round($(this.options.target).width()/100)),this.definition.yAxis=d3.axisLeft().scale(this.definition.y).ticks(this.options.y[0].ticks),this.definition.x.domain([this.definition.x.min,this.definition.x.max]),this.skipBandDomainSet||(this.definition.x1.domain(this.data[0].map(function(t){return t.x})),this.skipBandDomainSet=!1),this.definition.y.domain([this.definition.y.min,this.definition.y.max]).nice(),e=this.definition.x.max,console.log("Max = ",e),i=[[-(1/0),0],[this.definition.x(new Date),this.definition.dimensions.innerHeight]],this.definition.zoom=d3.zoom().scaleExtent([this.options.zoom.scale.min,this.options.zoom.scale.max]).translateExtent(i).on("zoom",function(){var i
