...
if(i=JSON.parse(t).templateData,this.isValid(i)){for(o=[],n=e=s=i.length-1;s<=0?e<=0:e>=0;n=s<=0?++e:--e)r=i[n],null!=r?(r.x.min=new window.Plotter.Now(this.plotter.lib.format,r.x.min).get(),r.x.max=new window.Plotter.Now(this.plotter.lib.format,r.x.max).get()):i.splice(n,1)
