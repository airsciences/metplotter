...
return this.appendCrosshairTarget(n),n}},t.prototype.setCrosshair=function(t,i){var e,n,s,o,r,a,l,p,h,d,u,c,f,m,g,y
...
for(c in m)g=m[c],r=this.overlay.node(),s=g,i=i?i:d3.mouse(r),y=this.definition.x.invert(i[0]+o.leftPadding),t&&(y=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(s,y,1),y.getTime()<this.state.range.data[c].min.getTime()&&u--,y.getTime()>this.state.range.data[c].max.getTime()&&u--,u=y.getMinutes()>=30?u:u-1,null!=s[u]&&(h=t?t.applyX(this.definition.x(s[u].x)):this.definition.x(s[u].x),d=[],a=[],null!==this.options.y[c].variable&&(a[c]=s[u],null!=a[c]&&(d[c]=this.definition.y(a[c].y),n=this.displayDate(a[c].x),isNaN(d[c])||null==a[c].y||this.focusRect[c].attr("transform","translate(0, 0)"))),l=h-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),this.focusDateText.attr("x",l-120).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n)),null===this.options.y[c].variable||isNaN(d[c])||null==a[c].y||(this.focusRect[c].attr("width",t.k*this.definition.x1.bandwidth()).attr("x",h).attr("y",d[c]),this.focusText[c].attr("x",h+o.leftPadding/10+t.k*this.definition.x1.bandwidth()+2).attr("y",d[c]-o.topPadding/10).text(null!=a[c].y?"wind_direction"===e.options.y[0].variable?p(a[c].y):a[c].y.toFixed(2)+" "+this.options.y[c].units:void 0)))
...
return a=location.protocol+"//dev.nwac.us/api/v5/dataloggerregion?sensor_name="+e,n=this,s={},r=this.getCurrent(t),l=this.plotter.lib.uuid(),o=function(e){var s,o,r,a,p,h,d,u,c,f
...
o+=" </ul>"}return o+=" </ul> </li>",$(i).prepend(o),$("#"+l).dropdown(),n.bindSubMenuEvent(".subheader"),n.setCurrent(t),n.updateStationDropdown(t),n.appendStationMap(t,i,e.responseJSON.results)},this.api.get(a,s,o)},t.prototype.updateStationDropdown=function(t){var i,e,n,s,o,r,a,l,p,h,d,u,c,f,m
...
return l=location.protocol+"//dev.nwac.us/api/v5/sensortype?sensors__data_logger="+n,o={},a=this.getCurrent(t),p=this.plotter.lib.uuid(),s=[],r=function(n){var s,o,r,l,h,d,u,c,f,m
...
return a},t.prototype.boundOnSelected=function(t){var i,e,n,s,o,r,a,l,p,h
...
return e=this,n='<i id="remove-'+t+'" style="cursor: pointer;" title="Remove Plot" class="icon-remove"></i>',$(i).append(n),$("#remove-"+t).on("click",function(){return e.plotter.remove(t)})},t.prototype.new=function(t){var i,e,n,s,o,r,a,l,p,h,d
...
case!(t>=326.25&&t<348.75):return"NNW"
case!(t>=348.75&&t<=360):return"N"}},m=this.data
for(c in m)g=m[c],r=this.overlay.node(),s=g,i=i?i:d3.mouse(r),y=this.definition.x.invert(i[0]+o.leftPadding),t&&(y=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(s,y,1),y.getTime()<this.state.range.data[c].min.getTime()&&u--,y.getTime()>this.state.range.data[c].max.getTime()&&u--,u=y.getMinutes()>=30?u:u-1,null!=s[u]&&(h=t?t.applyX(this.definition.x(s[u].x)):this.definition.x(s[u].x),d=[],a=[],null!==this.options.y[c].variable&&(a[c]=s[u],null!=a[c]&&(d[c]=this.definition.y(a[c].y),n=this.displayDate(a[c].x),isNaN(d[c])||null==a[c].y||this.focusCircle[c].attr("transform","translate(0, 0)"))),l=h-o.leftPadding,l>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",l).attr("y1",o.topPadding).attr("x2",l).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",l).attr("y",o.topPadding).attr("width",o.innerWidth-l).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)"),this.focusDateText.attr("x",l-120).attr("y",o.topPadding+o.innerHeight-3).attr("transform","translate("+o.leftPadding+", 0)").text(n)),null===this.options.y[c].variable||isNaN(d[c])||null==a[c].y||(this.focusCircle[c].attr("cx",h).attr("cy",d[c]),this.focusText[c].attr("x",h+o.leftPadding/10).attr("y",d[c]-o.topPadding/10).text(a[c].y?"wind_direction"===e.options.y[0].variable?p(a[c].y):a[c].y.toFixed(1)+" "+this.options.y[c].units:void 0)))
return i}},t.prototype.showCrosshair=function(){var t,i,e,n
if(this.initialized){this.crosshairs.select(".crosshair-x").style("display",null),this.crosshairs.select(".crosshair-x-under").style("display",null),this.focusDateText.style("display",null),t=this.options.y,i=[]
