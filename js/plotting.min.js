...
if(a=o.template[i],void 0===a.__data&&(a.__data=[]),void 0===a.__data[t]?a.__data[t]=new window.Plotting.Data(e.responseJSON.results):a.__data[t].join(e.responseJSON.results,[a.proto.options.x.variable]),a.__data[t].getSourceCount()===n)return a.proto.initialized?(a.proto.appendData(a.__data[t].get()),a.proto.update()):(a.proto.setData(a.__data[t].get()),a.proto.append()),delete a.__data[t]},this.api.get(l,a,s)},t.prototype.prependData=function(t){var i,e,o,n,a,s,r,l
