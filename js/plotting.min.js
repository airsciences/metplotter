...
if(t=this,$("#save-"+this.options.localId).parent().remove(),this.isAdmin()||null!=this.options.uuid)return $(this.options.target).prepend('<small><a style="cusor:pointer" id="save-'+this.options.uuid+'">Save Graphs</a></small>'),$("#save-"+this.options.uuid).on("click",function(i){return t.i.template.put()})},t}()}.call(this),function(){var t
