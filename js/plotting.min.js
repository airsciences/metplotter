...
this.preError="Plotting.Dropdown",this.plotter=t,n={target:null},this.options=Object.mergeDefaults(e,n),o={token:null,expires:null,expired:!0},i=Object.mergeDefaults(i,o),this.maps=[],this.markers={},this.listeners={},this.api=new window.Plotting.API(i.token)}return t.prototype.appendStationDropdown=function(t,i,e,o){var n,a,s,r,l
return r=location.protocol+"//dev.nwac.us/api/v5/dataloggerregion?sensor_name="+e,n=this,a={},l=this.uuid(),s=function(e){var a,s,r,p,d,h,u,c,f,m,y,g,v,x,b,w,P,D,S,T,k,_,M,C,I,O,N,A
for(f='<div class="dropdown"> <li><a id="'+l+'" class="station-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="station-dropdown-'+t+'" class="dropdown-menu dropdown-menu-right">',_=e.responseJSON.results,m=0,b=_.length;b>m;m++){for(N=_[m],u="",k="",a='<span class="station-dots">',p=0,M=N.dataloggers,g=0,w=M.length;w>g;g++)h=M[g],d=n.isCurrent(o,"dataLoggerId",h.id),d&&(p++,a=a+' <i class="icon-circle" style="color: '+d.color+'"></i>')
for(p>0&&(k='style="background-color: rgb(248,248,248)"',u='style="font-weight: 700"'),f=f+' <li class="subheader" '+k+"> <a "+u+' href="#"><i class="icon-caret-down" style="margin-right: 6px"></i> '+N.name+" "+a+'</span></a> </li> <ul class="list-group-item sublist" style="display: none;">',C=N.dataloggers,v=0,P=C.length;P>v;v++)A=C[v],d=n.isCurrent(o,"dataLoggerId",A.id),c="",d&&(c='style="color: '+d.color+'"'),y="data-logger-"+A.id+"-plot-"+t,r='<i id="'+y+'" class="icon-circle" '+c+"></i>",s="add-station-"+t+"-"+A.id,f=f+' <li class="station" id="'+s+'" data-station-id="'+A.id+'" data-plot-id="'+t+'" style="padding: 1px 5px; cursor: pointer; list-style-type: none" onclick=""> '+r+" "+A.datalogger_name+" | "+A.elevation+" ft</li>"
f+=" </ul>"}for(f+=" </ul> </li>",$(i).prepend(f),I=e.responseJSON.results,x=0,D=I.length;D>x;x++)for(N=I[x],O=N.dataloggers,T=0,S=O.length;S>T;T++)A=O[T],s="add-station-"+t+"-"+A.id,$("#"+s).on("click",function(t){var i,e
return t.stopPropagation(),i=$(this).attr("data-plot-id"),e=$(this).attr("data-station-id"),n.plotter.addStation(i,e)})
return $("#"+l).dropdown(),n.bindSubMenuEvent(".subheader"),n.appendStationMap(t,i,e.responseJSON.results,o)},this.api.get(r,a,s)},t.prototype.updateStationDropdown=function(t){var i,e,o,n,a
return i=this,n=this.plotter.template[t].proto.options,e="",null!==n.y.dataLoggerId&&(o=n.y.dataLoggerId,e=' <i class="icon-circle" style="color: '+n.y.color+'"></i>',a="data-logger-"+o+"-plot-"+t,$(n.target).find("#"+a).css("color",n.y.color).parent().parent().prev().css("background-color","rgb(248,248,248)").css("font-weight",700).children(":first").children(".station-dots").empty().append(e),$("#add-station-"+t+"-"+o).off("click").on("click",function(t){var e,o
return t.stopPropagation(),console.log("this",$(this)),e=$(this).attr("data-plot-id"),o=$(this).attr("data-station-id"),i.plotter.removeStation(e,o)})),null!==n.y2.variable&&(o=n.y2.dataLoggerId,e=' <i class="icon-circle" style="color: '+n.y2.color+'"></i>',a="data-logger-"+o+"-plot-"+t,$(n.target).find("#"+a).css("color",n.y2.color).parent().parent().prev().css("background-color","rgb(248,248,248)").css("font-weight",700).children(":first").append(e),$("#add-station-"+t+"-"+o).off("click").on("click",function(t){var e,o
return t.stopPropagation(),e=$(this).attr("data-plot-id"),o=$(this).attr("data-station-id"),i.plotter.removeStation(e,o)})),null!==n.y3.variable?(o=n.y3.dataLoggerId,e=' <i class="icon-circle" style="color: '+n.y3.color+'"></i>',a="data-logger-"+o+"-plot-"+t,$(n.target).find("#"+a).css("color",n.y3.color).parent().parent().prev().css("background-color","rgb(248,248,248)").css("font-weight",700).children(":first").append(e),$("#add-station-"+t+"-"+o).off("click").on("click",function(t){var e,o
return t.stopPropagation(),e=$(this).attr("data-plot-id"),o=$(this).attr("data-station-id"),i.plotter.removeStation(e,o)})):void 0},t.prototype.appendParameterDropdown=function(t,e,o,n){var a,s,r,l,p
...
for(n=this,_=this.uuid(),u="map-control-"+t,c='<li data-toggle="popover" data-placement="left"> <i id="map-'+t+'" class="icon-map-marker" style="cursor: pointer"></i> </li> <div class="popover" style="max-width: 356px;"> <div class="arrow"></div> <div class="popover-content"> <div id="'+u+'" style="width: 312px; height: 312px;"></div> </div> </div>',$(i).prepend(c),$("#map-"+t).on("click",function(){return n.plotter.controls.toggleMap(t)}),this.maps[t]=new google.maps.Map(document.getElementById(u),{center:new google.maps.LatLng(46.98,-121.98),zoom:6,maxZoom:12,mapTypeId:"terrain",zoomControl:!0,mapTypeControl:!1,scaleControl:!1,streetViewControl:!1,rotateControl:!1,fullscreenControl:!1}),m=new google.maps.InfoWindow({content:"",disableAutoPan:!0}),s=new google.maps.LatLngBounds,a=[],f=0,v=e.length;v>f;f++)for(S=e[f],D=S.dataloggers,y=0,x=D.length;x>y;y++)k=D[y],h="rgb(200,200,200)",T=5,P=.5,d="map-plot-"+t+"-station-"+k.id,p=n.isCurrent(o,"dataLoggerId",k.id),p&&(h=p.color,T=7,P=.8,a.push(new google.maps.LatLng(k.lat,k.lon))),w=new google.maps.Marker({position:{lat:k.lat,lng:k.lon},id:d,tooltip:k.datalogger_name+" - "+k.elevation+" ft",dataloggerid:k.id,icon:{path:google.maps.SymbolPath.CIRCLE,scale:T,strokeWeight:2,fillOpacity:P,fillColor:h},selected:!1}),w.addListener("mouseover",function(){return m.setContent(this.tooltip),m.open(n.maps[t],this)}),w.addListener("mouseout",function(){return m.close()}),this.listeners[d]=w.addListener("click",function(){return console.log("Marker clicked",this),n.plotter.addStation(t,this.dataloggerid)}),r=this.markers[d]=w,this.markers[d].setMap(this.maps[t])
for(g=0,b=a.length;b>g;g++)l=a[g],s.extend(l)
return this.maps[t].fitBounds(s),this.maps[t].setZoom(12)},t.prototype.resetStationMap=function(t){var i,e,o,n,a,s
i=this,a=this.markers,s=[]
for(o in a)n=a[o],e=n.get("dataloggerid"),n.setIcon({path:google.maps.SymbolPath.CIRCLE,scale:5,strokeWeight:2,fillOpacity:.5,fillColor:"rgb(200,200,200)"}),n.set("selected",!1),i.listeners[o].remove(),s.push(n.addListener("click",function(){return i.plotter.addStation(t,e)}))
return s},t.prototype.updateStationMap=function(t){var i,e,o,n,a,s,r
return i=this,this.resetStationMap(t),r=function(t,e,o,n){return i.markers[o].setIcon({path:google.maps.SymbolPath.CIRCLE,scale:7,strokeWeight:2,fillOpacity:.8,fillColor:n}),i.markers[o].set("selected",!0),i.listeners[o].remove(),i.markers[o].addListener("click",function(){return i.plotter.removeStation(t,e)})},a=this.plotter.template[t].proto.options,null!==a.y.variable&&(n=a.y.variable.replace("_","-"),s="map-plot-"+t+"-station-"+a.y.dataLoggerId,o=a.y.dataLoggerId,e=a.y.color,r(t,o,s,e)),null!==a.y2.variable&&(n=a.y2.variable.replace("_","-"),s="map-plot-"+t+"-station-"+a.y2.dataLoggerId,o=a.y2.dataLoggerId,e=a.y2.color,r(t,o,s,e)),null!==a.y3.variable&&(n=a.y3.variable.replace("_","-"),s="map-plot-"+t+"-station-"+a.y3.dataLoggerId,o=a.y3.dataLoggerId,e=a.y3.color,r(t,o,s,e)),console.log("Updating markers row (marker, color)",this.markers[s],e)},t.prototype.toggleMap=function(t){var i,e,o
return i=this.plotter.controls.maps[t].getCenter(),o=this.plotter.controls.maps[t].getZoom(),e=$("#map-control-"+t).parent().parent().prev().offset(),$("#map-control-"+t).parent().parent().toggle().css("left",e.left-356).css("top",e.top),google.maps.event.trigger(this.plotter.controls.maps[t],"resize"),this.plotter.controls.maps[t].setCenter(i),this.plotter.controls.maps[t].setZoom(o)},t.prototype.toggle=function(t){return $(t).toggle()},t.prototype.move=function(t,i,e){var o,n
...
return i=this,n=this.uuid(),e='<ul id="new-'+n+'-dropdown" class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="new-'+n+'"> <li><a id="new-'+n+'-parameter" style="cursor: pointer">Add Parameter Plot</a></li> <li><a id="new-'+n+'-station" style="cursor: pointer">Add Station Plot</a></li> </ul>',o='<div class="dropdown"> <li><a id="new-'+n+'" role="button" href="#"> <i class="icon-plus"></i> </a></li> </div>',$(t).append(o),$("#new-"+n).on("click",function(){return i.plotter.add("parameter")})},t.prototype.uuid=function(){return(4294967296*(1+Math.random())|0).toString(16).substring(1)},t.prototype.isCurrent=function(t,i,e){var o,n
...
return n=this.preError+".getTemplate(...)",a="template/"+this.options.plotHandlerId,e=null,i=this,o=function(t){return null===t.responseJSON||t.responseJSON.error?void console.log(n+".callback(...) error detected (data)",t):i.template=t.responseJSON.templateData},this.syncronousapi.get(a,e,o)},t.prototype.putTemplate=function(){var t,i,e,o,n
return o=this.preError+".putTemplate()",n="template/"+this.options.plotHandlerId,i={templateId:this.options.templateId,templateData:this.template},t=this,e=function(t){return null===t.responseJSON||t.responseJSON.error?void console.log(o+".callback(...) error detected (data)",t):console.log(o+".callback() success saving template.")},this.api.put(n,i,e)},t.prototype.getStationParamData=function(t,i){var e,o,n,a,s
return a=this.preError+".getStationParamData()",s=location.protocol+"//dev.nwac.us/api/v5/measurement",e=this,o=this.template[t].dataParams[i],n=function(i){return void 0===e.template[t].data?e.template[t].data=[i.responseJSON.results]:e.template[t].data.push(i.responseJSON.results),console.log(a+" (template.data)",e.template[t].data)},this.syncronousapi.get(s,o,n)},t.prototype.getTemplatePlotData=function(){var t,i,e,o,n,a,s
...
return r=this.preError+".getAppendData(key, dataParams)",l="http://dev.nwac.us/api/v5/measurement",o=this,a=this.template[i].proto.options.dataParams[e],n=this.template[i].proto.options.dataParams.length,s=function(e){var a
...
return this.controls.updateStationDropdown(t)},t.prototype.removeStation=function(t,i){var e,o,n,a
return e=null,console.log("Remove Station (plotId, dataLoggerId)",t,i),a=this.template[t],n=this.template[t].proto,o=this.indexOfValue(a.dataParams,"data_logger",i),n.options.y.dataLoggerId===i?e="y":n.options.y2.dataLoggerId===i?e="y2":n.options.y3.dataLoggerId===i&&(e="y3"),o>-1&&(a.dataParams.splice(o,1),n.options[e]=null,n.appendData(),"y"===e&&(n.options.y=Object.mergeDefaults(n.options.y,n.defaults.y)),"y2"===e&&(n.options.y2=Object.mergeDefaults(n.options.y2,n.defaults.y2)),"y3"===e&&(n.options.y3=Object.mergeDefaults(n.options.y3,n.defaults.y3)),n.getDefinition(),n.removeData(e),n.update()),this.controls.updateStationDropdown(t)},t.prototype.zoom=function(t){var i,e,o,n,a
