...
if(this.isAdmin())return $(this.options.target).append('<small><a style="cusor:pointer" id="save-'+this.options.uuid+'">Save Template</a></small>'),$("#save-"+this.options.uuid).on("click",function(e){return t.i.template.put()})},t.prototype.remove=function(t){return $(this.plots[t].proto.options.target).fadeOut(500,function(){return $(this).remove()}),this.i.template.removePlot(t),delete this.plots[t]},t.prototype.move=function(t,e){var i,o,n,r,s,a
...
if(i=this.lib.indexOfValue(this.plots[t].proto.options.y,"dataLoggerId",e),i>=0)return delete this.i.template.template[t].y[i],this.plots[t].proto.removeData(i),this.plots[t].proto.getDefinition(),this.plots[t].proto.update(),this.i.controls.updateStationDropdown(t),this.i.controls.updateStationMap(t),this.i.controls.removeSpinner(t)},t}()}.call(this),function(){var t
