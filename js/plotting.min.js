...
for(e in r)a=r[e],a.min===!0&&this.isReady()&&n.proto.state.requested.data[e].min===!1&&(this.updates++,n.proto.state.requested.data[e].min=!0,this.i.livesync.prepend(s,e,l)),i=new Date,(this.refreshCounter%this.waitCounter===0||n.proto.state.range.data[0].max.getTime()<i.getTime()-432e5)&&a.max===!0&&this.isReady()&&n.proto.state.requested.data[e].max===!1&&(this.updates++,n.proto.state.requested.data[e].max=!0,this.i.livesync.append(s,e,l))}if(!t)return setTimeout(Plotter.Handler.prototype.listen.bind(this),this.options.refresh)},t.prototype.append=function(){var t,i,e,n,s
t=this,n=this.plots
