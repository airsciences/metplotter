...
this.preError="Plotter.API",e=this.preError+".constructor()",this.async=!0,"undefined"!=typeof i&&(this.async=i),this.getAccessToken=function(){return t},this.getAccessTokenValue=function(){return"Token "+t}}return t.prototype.build=function(){var t,i,e
...
return-1}
window.Plotter||(window.Plotter={}),window.Plotter.Controls=t=function(){function t(t,i,e){var n,o
this.preError="Plotter.Dropdown",this.plotter=t,o={target:null},this.options=Object.mergeDefaults(e,o),n={token:null,expires:null,expired:!0},i=Object.mergeDefaults(i,n),this.current=[],this.stations=[],this.maps=[],this.markers={},this.listeners={},this.api=new window.Plotter.API(i.token)}return t.prototype.setCurrent=function(t){var i,e,n,o,a,s,r
...
return r=location.protocol+"//dev.nwac.us/api/v5/dataloggerregion?sensor_name="+e,o=this,a={},l=this.uuid(),this.setCurrent(t),s=function(e){var a,s,r,p,d,h,u,c,f,m
for(o.stations[t]=e.responseJSON.results,s='<div class="dropdown"> <li><a id="'+l+'" class="station-dropdown dropdown-toggle" role="button" data-toggle="dropdown" href="#"> <i class="icon-list"></i></a> <ul id="station-dropdown-'+t+'" class="dropdown-menu pull-right">',u=o.stations[t],r=0,d=u.length;r<d;r++){for(f=u[r],a=o.__lcname(f.name),s=s+' <li class="subheader"> <a data-region="'+a+'" data-plot-id="'+t+'" href=""> <i class="icon-caret-down" style="margin-right: 6px"></i> <span class="region-name">'+f.name+'</span> <span class="region-dots"></span> </a> </li> <ul class="list-group-item sublist" style="display: none;">',c=f.dataloggers,p=0,h=c.length;p<h;p++)m=c[p],s=s+' <li class="station" data-station-id="'+m.id+'" data-plot-id="'+t+'" style="padding: 1px 5px; cursor: pointer; list-style-type: none"> <i class="icon-circle"></i> <span class="station-name"> '+m.datalogger_name+" | "+m.elevation+" ft </span> </li>"
s+=" </ul>"}return s+=" </ul> </li>",$(i).prepend(s),$("#"+l).dropdown(),o.bindSubMenuEvent(".subheader"),o.updateStationDropdown(t),o.appendStationMap(t,i,e.responseJSON.results,n)},this.api.get(r,a,s)},t.prototype.updateStationDropdown=function(t){var i,e,n,o,a,s,r,l,p,d,h,u,c,f,m,y
...
return t.stopPropagation(),e=$(this).attr("data-plot-id"),$(this).append('<i class="icon-spinner icon-spin" data-plot-id="'+e+'"></i>'),i.addStation(e,$(this).attr("data-station-id"))})},u=this.stations[t],m=[],l=0,d=u.length;l<d;l++){for(f=u[l],a=this.__lcname(f.name),s="",r="",o="",f.displayed.length>0&&(o="rgb(248, 248, 248)",r=700,s=n(f.displayed)),c=f.dataloggers,p=0,h=c.length;p<h;p++)y=c[p],$('[data-station-id="'+y.id+'"][data-plot-id="'+t+'"]> i.icon-circle').css("color",y.color),e(t,i.plotter,y)
$('[data-region="'+a+'"][data-plot-id="'+t+'"]').css("background-color",o).css("font-weight",r),m.push($('[data-region="'+a+'"][data-plot-id="'+t+'"] > span.region-dots').html(s))}return m},t.prototype.removeSpinner=function(t){return $('i.icon-spinner[data-plot-id="'+t+'"]').remove()},t.prototype.appendParameterDropdown=function(t,e,n,o){var a,s,r,l,p
...
return this.preError="Plotter.Data.",i=this.preError+".constructor(...)",t instanceof Array?(this.data=$.extend(!0,[],t),this.sourceCount=1,void(this.test=function(t,e,n){var o,a,s,r,l,p
...
t[p]instanceof Date?t[p].getTime()===e[p].getTime()&&o++:t[p]===e[p]&&o++}return o===a&&(l=!0),l})):void console.log(i+" data not of type array.")}return t.prototype.join=function(t,e){var n,o,a,s,r,l,p,d,h,u,c,f,m,y,g
...
window.Plotter||(window.Plotter={}),window.Plotter.LinePlot=t=function(){function t(t,e,n){var o,a
...
return i=new Plotter.Data(n),n=i._clean(i.get()),n.sort(this.sortDatetimeAsc)},t.prototype.setData=function(t){var i,e
...
if(i=this.processData(t),e=new Plotter.Data(this.data),e.append(i,["x"]),this.data=e._clean(e.get()),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.removeData=function(t){var i,e,n,o,a
a=[],o=this.data
for(e in o)n=o[e],delete n[t],delete n[t+"Min"],delete n[t+"Max"],a[e]=n
if(i=new Plotter.Data(a),this.data=i.get(),this.data=this.data.sort(this.sortDatetimeAsc),this.initialized)return this.setDataState(),this.setIntervalState(),this.setDataRequirement()},t.prototype.setDataState=function(){var t,i,e,n
...
if(this.initialized)return c=this.preError+".setCrosshair(mouse)",e=this,o=this.definition.dimensions,a=this.overlay.node(),n=this.overlay.datum(),i=i?i:d3.mouse(a),f=this.definition.x.invert(i[0]+o.leftPadding),t&&(f=this.definition.x.invert(t.invertX(i[0]+o.leftPadding))),u=e.bisectDate(n,f,1),r=f.getMinutes()>=30?n[u]:n[u-1],f.getTime()<this.state.range.data.min.getTime()&&(r=n[u-1]),f.getTime()>this.state.range.data.max.getTime()&&(r=n[u-1]),l=t?t.applyX(this.definition.x(r.x)):this.definition.x(r.x),null!==this.options.y.variable&&(p=this.definition.y(r.y),isNaN(p)||this.focusCircle.attr("transform","translate(0, 0)")),null!==this.options.y2.variable&&(d=this.definition.y(r.y2),isNaN(d)||this.focusCircle2.attr("transform","translate(0, 0)")),null!==this.options.y3.variable&&(h=this.definition.y(r.y3),isNaN(h)||this.focusCircle3.attr("transform","translate(0, 0)")),null!==r&&void 0!==r||console.log("d is broken (d)",r),s=l-o.leftPadding,s>=0&&(this.crosshairs.select(".crosshair-x").attr("x1",s).attr("y1",o.topPadding).attr("x2",s).attr("y2",o.innerHeight+o.topPadding).attr("transform","translate("+o.leftPadding+", 0)"),this.crosshairs.select(".crosshair-x-under").attr("x",s).attr("y",o.topPadding).attr("width",o.innerWidth-s).attr("height",o.innerHeight).attr("transform","translate("+o.leftPadding+", 0)")),null===this.options.y.variable||isNaN(p)||(this.focusCircle.attr("cx",l).attr("cy",p),this.focusText.attr("x",l+o.leftPadding/10).attr("y",p-o.topPadding/10).text(r.y?r.y.toFixed(1)+" "+this.options.y.units:void 0)),null===this.options.y2.variable||isNaN(d)||(this.focusCircle2.attr("cx",l).attr("cy",d),this.focusText2.attr("x",l+o.leftPadding/10).attr("y",d-o.topPadding/10).text(r.y2?r.y2.toFixed(1)+" "+this.options.y2.units:void 0)),null===this.options.y3.variable||isNaN(h)||(this.focusCircle3.attr("cx",l).attr("cy",h),this.focusText3.attr("x",l+o.leftPadding/10).attr("y",h-o.topPadding/10).text(r.y3?r.y3.toFixed(1)+" "+this.options.y3.units:void 0)),null!==this.options.y.variable&&null!==this.options.y2.variable&&null!==this.options.y3.variable&&(m=[],this.svg.selectAll(".focus-text").attr("transform",function(t,i){var e
...
return setTimeout(Plotter.Handler.prototype.listen.bind(this),this.options.refresh)},t.prototype.listenTest=function(){var t,i,e
...
for(r in d){if(l=d[r],u=this.utarget(this.options.target),$(this.options.target).append("<div id='"+u+"'></div>"),this.mergeTemplateOption(r),void 0===l.options.y2&&(l.options.y2={}),void 0===l.options.y3&&(l.options.y3={}),l.options.plotId=r,l.options.uuid=this.uuid(),l.options.target="#"+u,l.options.y.color=this.getColor("light",r),l.options.y2.color=this.getColor("light",parseInt(r+4)),l.options.y3.color=this.getColor("light",parseInt(r+6)),e=this.getVariableBounds(l.options.y.variable),e&&(l.options.y.min=e.min,l.options.y.max=e.max),"temperature"===l.options.y.variable&&(l.options.y.maxBarValue=32),i=new window.Plotter.Data(l.data[0]),n=l.data.length-1,n>0)for(o=s=1,h=n;1<=h?s<=h:s>=h;o=1<=h?++s:--s)i.join(l.data[o],[l.options.x.variable])
c=this.getTitle(l),a=new window.Plotter.LinePlot(this,i.get(),l.options),a.preAppend(),a.append(),this.template[r].proto=a,this.appendControls(r)}if(this.isAdmin())return $(this.options.target).append('<small><a style="cusor:pointer" id="save-'+u+'">Save Template</a></small>'),$("#save-"+u).on("click",function(i){return t.putTemplate()})},t.prototype.mergeTemplateOption=function(t){var i,e
...
return o},t.prototype.appendControls=function(t){var i,e,n
return n="plot-controls-"+t,i="",e='<ul id="'+n+'" class="unstyled" style="list-style-type: none; padding-left: 6px;"> </ul>',$(this.template[t].proto.options.target).find(".line-plot-controls").append(e),this.controls.move(t,"#"+n,"up"),this.controls.new("#"+n,"down"),this.controls.remove(t,"#"+n),this.controls.move(t,"#"+n,"down")},t.prototype.remove=function(t){return $(this.template[t].proto.options.target).fadeOut(500,function(){return $(this).remove()}),this.template[t]=null},t.prototype.move=function(t,i){var e,n,o
